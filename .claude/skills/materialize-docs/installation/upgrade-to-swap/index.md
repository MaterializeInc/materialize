---
audience: developer
canonical_url: https://materialize.com/docs/installation/upgrade-to-swap/
...
> **Disambiguation:** This page outlines the general steps for upgrading from v25.2 to v26.0 if you
