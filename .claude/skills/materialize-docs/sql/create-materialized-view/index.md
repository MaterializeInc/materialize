---
audience: developer
canonical_url: https://materialize.com/docs/sql/create-materialized-view/
complexity: advanced
description: '`CREATE MATERIALIZED VIEW` defines a view that is persisted in durable
  storage and incrementally updated as new data arrives.'
doc_type: reference
keywords:
- cross-cluster access
- queried from any cluster
- CREATE A
- IF NOT EXISTS
...
[See diagram: create-materialized-view.svg]
