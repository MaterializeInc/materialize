---
audience: developer
canonical_url: https://materialize.com/docs/sql/explain-analyze/
complexity: advanced
description: Reference page for `EXPLAIN ANALYZE`. `EXPLAIN ANALYZE` is used to understand
  the performance of indexes and materialized views.
doc_type: reference
keywords:
- EXPLAIN ANALYZE
- 'Warning:'
...
information](../sql/system-catalog/mz_introspection/)
