...
See the [README in the MaterializeInc/materialize repo](
    https://github.com/MaterializeInc/materialize/blob/main/doc/developer/design/README.md)
    for Materialize's guidance on:
- What's the purpose of a design document?
- Goals of a design doc.
- Non-goals of a design doc.
- When should you make a design document?
- How should you make a design document?
- The creation, iteration, and approval process.
