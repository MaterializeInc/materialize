...
import WelcomeDialog from "~/components-v2/WelcomeDialog/WelcomeDialog";
import { OrgTag } from "~/layouts/footerTagComponents";
import { FIXED_TOP_BAR_Z_INDEX, MAIN_CONTENT_Z_INDEX } from "~/layouts/zIndex";
import FloatingResultPanel from "~/platform/v2/layouts/FloatingResultPanel";
import { NavBar } from "~/platform/v2/layouts/NavBar";
import PageFooter from "~/platform/v2/layouts/PageFooter";
import { SHELL_SLUG } from "~/platform/v2/routeHelpers";
import {
...
const CatalogPanel = React.lazy(
  () => import("~/platform/v2/worksheet/CatalogPanel"),
);
