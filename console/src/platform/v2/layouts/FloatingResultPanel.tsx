...
import ResultsPanel from "~/platform/v2/worksheet/ResultsPanel";
import {
  ...
  worksheetResultAtom,
} from "~/platform/v2/worksheet/store";
...
const FloatingResultPanel = () => {
  ...
  const cancelFromWorksheet = useAtomValue(worksheetCancelAtom);
    ...
    >
      ...
      <Box flex="1" overflow="auto">
        <ResultsPanel
          ...
          onCancel={cancelFromWorksheet ?? noop}
        />
      </Box>
    </Flex>
  );
