...
outcomes we hope results from this work. Feel free to list both qualitative
...
Start this section with a brief, high-level overview that provides a summary
without requiring all the details.
...
- A hacky but working live demo of a feature running on your laptop or in a
  staging environment
...
This step is crucial for de-risking the design as early as possible, but in
some cases it can be beneficial to get eyes on the initial proposal without a
prototype. If you would like to skip or delay the prototype, please explicitly
mention it in this section and provide details on why you are skipping or
delaying it.
-->
