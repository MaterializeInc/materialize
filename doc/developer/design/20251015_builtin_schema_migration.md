...
Notably, it ignores any entries at different versions, to avoid any interference with concurrent processes.
...
Additionally, it cleans up durable state written by earlier versions by:
