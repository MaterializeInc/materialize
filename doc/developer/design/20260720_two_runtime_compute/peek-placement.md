...
any of it. See [design.md](design.md) for how S1 and S5 score against the mechanisms.
...
carry S5's case. All three exist and are described in [evaluation.md](evaluation.md):
