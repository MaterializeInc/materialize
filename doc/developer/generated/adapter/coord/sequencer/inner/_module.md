...
`sequence_read_then_write` passes `DependencyPolicy::UserDml` to `validate_read_then_write_dependencies`, requiring every relation leaf in the selection to be a writable user table.
