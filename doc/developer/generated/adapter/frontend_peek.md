...
`PeekClient::try_frontend_peek` is the main entry point; it verifies the portal, delegates statement logging setup to `PeekClient::begin_statement_logging`, and then calls `try_frontend_peek_inner`.
