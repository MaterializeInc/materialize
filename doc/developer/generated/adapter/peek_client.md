...
Provides `PeekClient`, which bundles a `Client` handle with lazily-populated direct channels to each compute instance, a `PersistClient`, storage-collection frontier access, and a transient ID generator.
