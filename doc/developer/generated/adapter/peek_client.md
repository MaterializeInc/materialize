...
`begin_statement_logging` sets up statement logging for a frontend-sequenced operation: it begins a new execution log entry for fresh statements, or inherits and retires the outer context for nested executions (e.g., EXECUTE/FETCH).
