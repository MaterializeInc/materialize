...
Integration-level tests in this file exercise enum defaults, enum string encoding, schema resolution round-trips, protection against malformed length fields, and numeric promotion across union variants (union-to-union, concrete-writer-to-union-reader, and union-writer-to-concrete-reader promotion paths).
