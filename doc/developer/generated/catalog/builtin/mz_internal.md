...
This is the largest builtin submodule, exporting 195 public items: sources, tables, materialized views, views, indexes, and connections.
...
**Indexes** (`BuiltinIndex`) — 58 index constants accelerating queries on frequently accessed `mz_internal` views and tables.
