...
`CATALOG_VERSION` is the current schema version (82); `run_upgrade` chains individual `v{N}_to_v{N+1}` functions (v74 through v82) until the stored data matches the current version.
