...
`CATALOG_VERSION` is the current schema version (88); `run_upgrade` chains individual `v{N}_to_v{N+1}` functions (v74 through v88) until the stored data matches the current version.
