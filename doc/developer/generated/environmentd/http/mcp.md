...
Each endpoint is gated by a dynamic feature flag (`ENABLE_MCP_AGENTS`, `ENABLE_MCP_DEVELOPER`, `ENABLE_MCP_AGENTS_QUERY_TOOL`); response size is bounded by `MCP_MAX_RESPONSE_SIZE`.
