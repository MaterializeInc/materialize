...
Child modules: `func` provides all the concrete function implementations; `like_pattern` provides LIKE matching logic; `reduce` (private) holds the implementation of `MirScalarExpr::reduce`.
