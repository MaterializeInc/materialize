...
Defines the `FuncName` trait, which provides a canonical `NAME: &'static str` constant for each function struct. Functions generated by `#[sqlfunc]` receive their `FuncName` impl from that macro. Hand-written function structs declare theirs via the `func_name!` macro defined in this file.
