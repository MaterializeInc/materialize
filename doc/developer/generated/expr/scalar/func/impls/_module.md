...
Submodules: `array`, `audit_log_details`, `boolean`, `byte`, `case_literal`, `char`, `date`, `datum`, `float32`, `float64`, `int16`, `int2vector`, `int32`, `int64`, `interval`, `jsonb`, `list`, `map`, `mz_acl_item`, `mz_timestamp`, `numeric`, `oid`, `pg_legacy_char`, `range`, `record`, `regproc`, `string`, `time`, `timestamp`, `uint16`, `uint32`, `uint64`, `uuid`, `varchar`. The `audit_log_details` submodule exports `ParseCatalogAuditLogDetails`, a function that reshapes proto audit log data into the `as_json` format for `mz_catalog.mz_audit_events`.
