...
Defines `CollectionManager`, the central coordinator for all storage-managed (introspection) collections, which come in two flavors: append-only and differential.
