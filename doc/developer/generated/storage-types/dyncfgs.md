...
* **MySQL**: `MYSQL_REPLICATION_HEARTBEAT_INTERVAL` and `MYSQL_SOURCE_SNAPSHOT_PARALLELISM` (gates PK-range splitting of snapshot reads across workers, defaults `false`).
