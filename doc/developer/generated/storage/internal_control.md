...
`InternalCommandSender::from_parts` constructs a sender from externally provided channel and activator parts, for hosts that route internal commands through their own sequencing channel rather than `setup_command_sequencer`.
