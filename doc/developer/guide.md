...
as our config does not yet set up [cross-compilation support](https://github.com/MaterializeInc/materialize/blob/main/misc/python/materialize/xcompile.py)
...
provides some example run configurations to help get started with running and debugging
Materialize in RustRover.
