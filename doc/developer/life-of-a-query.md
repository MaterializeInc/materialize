...
computation to happen. Replicas come in multiple sizes that represent different
allocations of CPU cores and amount of memory. Finally, replicas are backed by
one or more `clusterd` processes/pods, depending on their size.
