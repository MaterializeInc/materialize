...
BYOC is a good fit if you need data residency, network isolation, direct control of the underlying infrastructure for your compliance requirements, or direct cloud cost visibility. AWS and GCP are in development; Azure is on the roadmap.
