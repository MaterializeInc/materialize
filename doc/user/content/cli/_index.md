...
[`--dataflow-eager-merge`](#dataflow-tuning) | N/A | *Advanced.* Amount of compaction to perform when idle.
[`--dataflow-progress-mode`](#dataflow-tuning) | eager | *Advanced.* Dataflow progress tracking mode.
...
Materialize's underlying dataflow engine:
  ...
  * `--dataflow-eager-merge` controls how aggressively Materialize will perform
    compaction when idle.
  * `--dataflow-progress-mode` sets Timely Dataflow's progress tracking mode.
