...
By default, the [`query` tool](/developer-tools/mcp-server/mcp-agent-tools/#query)
...
[ontology table](/fundamentals/architecture-patterns/ontology/): a curated catalog of the
