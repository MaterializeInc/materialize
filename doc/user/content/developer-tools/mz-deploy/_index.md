...
[Get started with mz-deploy](/developer-tools/mz-deploy/get-started/)
{{</ linkbox >}}
{{< linkbox title="Develop" >}}
- [Project structure](/developer-tools/mz-deploy/project-structure/)
- [Infrastructure](/developer-tools/mz-deploy/infrastructure/)
- [Local development](/developer-tools/mz-deploy/local-development/)
- [Editor setup](/developer-tools/mz-deploy/editor-setup/)
- [AI agent setup](/developer-tools/mz-deploy/agent-setup/)
{{</ linkbox >}}
{{< linkbox title="Deploy" >}}
- [Deployments](/developer-tools/mz-deploy/deployments/)
- [Stable APIs](/developer-tools/mz-deploy/stable-apis/)
- [Profiles](/developer-tools/mz-deploy/profiles/)
{{</ linkbox >}}
{{</ multilinkbox >}}
