...
aliases:
  ...
  - /serve-results/census/
  - /serve-results/sink/census/
menu:
  main:
    parent: sink
    name: "Census"
...
1. Set the connection parameters using the credentials provided in the [Materialize console](/developer-tools/console/).
