...
Tables](/export-data/iceberg-aws/), Snowflake can query that table
...
- An Iceberg sink writing to Amazon S3 Tables, set up by following the [AWS S3
  Tables guide](/export-data/iceberg-aws/), created with `MODE APPEND`.
...
- [AWS S3 Tables](/export-data/iceberg-aws/)
- [Apache Iceberg](/export-data/iceberg/)
- [`CREATE SINK`](/sql/create-sink/iceberg)
- [Snowflake](/export-data/snowflake/)
