...
Because hydration, not steady state, sets the floor on a cluster's size, start
at a size that hydrates comfortably and size down once you have measured what
hydration needed. For that procedure and the queries behind it, see [Cluster
