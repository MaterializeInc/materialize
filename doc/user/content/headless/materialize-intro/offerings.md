...
| **Materialize Self-Managed** | Deploy and operate Materialize in your Kubernetes environment. Whereas Materialize Cloud gives you a fully managed service, Materialize Self-Managed allows you to deploy Materialize in your own infrastructure.<br><br>{{< include-md file="content/headless/self-managed-deployments/editions-available.md" >}} | [Install self-managed](/self-managed-deployments/installation/install/) and try out the [Quickstart](/get-started/quickstart/). |
