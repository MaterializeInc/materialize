...
For improved performance, we recommend setting up the [EventBridge Pipe to output records in batches](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes-batching-concurrency.html). 
