...
menu:
  main:
    ...
    weight: 15
    identifier: "helm-upgrade-from-v25.2.12-azure"
---

{{< annotation type="Disambiguation: Terraform" >}}

This page is for upgrading via Helm. For upgrading your v25.2.12 or earlier
deployment using Terraform, see {{< include-md
