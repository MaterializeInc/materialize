...
| Tableau            | {{< supportLevel alpha >}}       | Connect using the [PostgreSQL database driver](https://help.tableau.com/current/pro/desktop/en-us/examples_postgresql.htm). Use the JDBC-based driver, which is included by default on Windows but requires an extra [driver download](https://www.tableau.com/support/drivers) on macOS and Linux. | [](#notify) |
