...
| Confluent Cloud Kafka | {{< supportLevel production >}} | Use [`SASL/PLAIN` authentication](/sql/create-connection/#kafka-sasl), to securely connect to a Confluent Cloud cluster. See the [source](/sql/create-source/kafka/) and [sink](/sql/create-sink/#kafka-sinks) documentation for more details.                                                                                                             |  |
