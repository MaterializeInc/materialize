...
other roles. Inheritance only applies to role privileges. Role attributes nor
variables are inherited. Inheriting privileges allows you to minimize the
number of roles you have to manage.
