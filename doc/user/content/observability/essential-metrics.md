...
menu:
  main:
    ...
    weight: 19
aliases:
  - /manage/monitor/essential-metrics/
---
...
Metrics](/observability/appendix-metrics/).
...
{{< metrics-table visibility="public" tag="compute" heading="Compute metrics" description="Metrics for compute objects, such as indexes and materialized views, running on [clusters](/fundamentals/concepts/clusters/) and their replicas." >}}
