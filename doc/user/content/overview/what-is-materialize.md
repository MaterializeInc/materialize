...
Materialize is able to ingest streams of data from Kafka, Kinesis, or local files
to create "sources". Sources monitor changes in the upstream data and continuously
pull new records into your Materialize instance. You can then interact with this data
in Materialize as if it were in a SQL table.
...
our query engine to create Differential dataflows that efficiently represent your data.
