...
`object_type`   | [`text`]                     | The type of the affected object: `cluster`, `cluster-replica`, `connection`, `continual-task`, `database`, `foreign-key`, `func`, `index`, `materialized-view`, `metric-sink`, `network-policy`, `role`, `schema`, `secret`, `sink`, `source`, `system`, `table`, `type`, or `view`.
...
| `owner_id`                | [`text`]             | The role ID of the owner of the cluster. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).                       |
...
`schema_id`  | [`text`]             | The ID of the schema to which the connection belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
...
`owner_id`   | [`text`]             | The role ID of the owner of the connection. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`owner_id`  | [`text`]             | The role ID of the owner of the database. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`schema_id`                 | [`text`]       | The ID of the schema to which the function belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
...
`owner_id`                  | [`text`]       | The role ID of the owner of the function. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`owner_id`   | [`text`]    | The role ID of the owner of the index. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
Field            | Type        | Meaning
-----------------|-------------|--------
`index_id`       | [`text`]    | The ID of the index which contains this column. Corresponds to [`mz_indexes.id`](/reference/system-catalog/mz_catalog/#mz_indexes).
...
`schema_id`    | [`text`]             | The ID of the schema to which the materialized view belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
`name`         | [`text`]             | The name of the materialized view.
`cluster_id`   | [`text`]             | The ID of the cluster maintaining the materialized view. Corresponds to [`mz_clusters.id`](/reference/system-catalog/mz_catalog/#mz_clusters).
`definition`   | [`text`]             | The materialized view definition (a `SELECT` query).
`owner_id`     | [`text`]             | The role ID of the owner of the materialized view. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`type`      | [`text`]             | The type of the object: one of `table`, `source`, `view`, `materialized-view`, `sink`, `metric-sink`, `index`, `foreign-key`, `connection`, `secret`, `type`, or `function`.
...
Field     | Type       | Meaning
----------|------------|--------
`role_id` | [`text`]   | The ID of the role the `member` is a member of. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
`member`  | [`text`]   | The ID of the role that is a member of `role_id`. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
`grantor` | [`text`]   | The ID of the role that granted membership of `member` to `role_id`. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
Field       | Type       | Meaning
------------|------------|--------
`role_id`   | [`text`]   | The ID of the role. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
Field     | Type       | Meaning
----------|------------|--------
`role_id` | [`text`]   | The ID of the role whose configuration parameter default is set. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`database_id` | [`text`]             | The ID of the database containing the schema. Corresponds to [`mz_databases.id`](/reference/system-catalog/mz_catalog/#mz_databases).
`name`        | [`text`]             | The name of the schema.
`owner_id`    | [`text`]             | The role ID of the owner of the schema. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`schema_id`      | [`text`]             | The ID of the schema to which the secret belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
`name`           | [`text`]             | The name of the secret.
`owner_id`       | [`text`]             | The role ID of the owner of the secret. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`schema_id`      | [`text`] | The ID of the schema to which the sink belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
`name`           | [`text`] | The name of the sink.
`type`           | [`text`] | The type of the sink: `kafka`.
`connection_id`  | [`text`] | The ID of the connection associated with the sink, if any. Corresponds to [`mz_connections.id`](/reference/system-catalog/mz_catalog/#mz_connections).
...
`cluster_id`     | [`text`] | The ID of the cluster maintaining the sink. Corresponds to [`mz_clusters.id`](/reference/system-catalog/mz_catalog/#mz_clusters).
`owner_id`       | [`text`] | The role ID of the owner of the sink. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`schema_id`      | [`text`]             | The ID of the schema to which the source belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
...
`owner_id`       | [`text`]             | The role ID of the owner of the source. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`schema_id`  | [`text`]             | The ID of the schema to which the table belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
`name`       | [`text`]             | The name of the table.
`owner_id`   | [`text`]             | The role ID of the owner of the table. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`source_id`  | [`text`]             | The ID of the source associated with the table, if any. Corresponds to [`mz_sources.id`](/reference/system-catalog/mz_catalog/#mz_sources).
...
`schema_id`    | [`text`]             | The ID of the schema to which the type belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
`name`         | [`text`]             | The name of the type.
`category`     | [`text`]             | The category of the type.
`owner_id`     | [`text`]             | The role ID of the owner of the type. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
...
`schema_id`    | [`text`]             | The ID of the schema to which the view belongs. Corresponds to [`mz_schemas.id`](/reference/system-catalog/mz_catalog/#mz_schemas).
`name`         | [`text`]             | The name of the view.
`definition`   | [`text`]             | The view definition (a `SELECT` query).
`owner_id`     | [`text`]             | The role ID of the owner of the view. Corresponds to [`mz_roles.id`](/reference/system-catalog/mz_catalog/#mz_roles).
