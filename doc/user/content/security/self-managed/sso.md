...
If you need SAML or SCIM, see the Ory-based [Enterprise SSO](/self-managed-deployments/enterprise-sso/) stack, which adds SAML, SCIM, and multi-IdP federation on top of the OIDC path documented here.
{{</ note >}}
