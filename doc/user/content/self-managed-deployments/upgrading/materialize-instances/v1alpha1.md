---
title: "v1alpha1"
description: "Upgrading Self-Managed Materialize instances using the v1alpha1 CRD API (before v26.30)."
menu:
  main:
...
trigger a new rollout by setting `requestRollout` to a new value.
