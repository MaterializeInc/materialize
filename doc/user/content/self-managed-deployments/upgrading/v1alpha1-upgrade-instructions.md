---
title: "v1alpha1 Upgrade Instructions"
description: "Upgrading Self-Managed Materialize using the v1alpha1 CRD API."
menu:
  main:
    parent: "upgrading"
    weight: 50
...
{{< warning >}}
These instructions apply to Materialize deployments using the `v1alpha1` CRD
API version. Upgrading using Materialize Operator v26.16 or later, or are using
`v1alpha2` CRD API version refer to the
[main upgrade instructions](/self-managed-deployments/upgrading/).
{{< /warning >}}
