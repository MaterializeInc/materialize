...
that specifies what actions can be performed on the bucket by the Materialize exporter role. For Materialize to
...
1. Enter a name for the role (e.g. `MZS3Exporter`), and click **Create role**.
