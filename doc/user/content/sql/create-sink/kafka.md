...
`NULL DEFAULTS`      | `bool` | Default: `false`. Whether to automatically have null defaults for nullable fields in the generated schemas.
...
When using a Confluent Schema Registry:
  ...
  * You can automatically have nullable fields in the Avro schemas to default to `null`
    by using the `NULL DEFAULTS` [flag](#syntax).
