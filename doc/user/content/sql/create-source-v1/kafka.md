...
- [`CREATE SOURCE`](/sql/create-source-v1/)
- [`SHOW SOURCES`](/sql/show-sources)
- [`DROP SOURCE`](/sql/drop-source)
- [Using Debezium](/integrations/debezium/)

[Avro]: /sql/create-source-v1/#avro
[JSON]: /sql/create-source-v1/#json
[Protobuf]: /sql/create-source-v1/#protobuf
[Text/bytes]: /sql/create-source-v1/#textbytes
[CSV]: /sql/create-source-v1/#csv

[Append-only envelope]: /sql/create-source-v1/#append-only-envelope
[Upsert envelope]: /sql/create-source-v1/#upsert-envelope
[Debezium envelope]: /sql/create-source-v1/#debezium-envelope
