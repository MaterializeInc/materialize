...
The following variables are available but cannot be modified and are not recognized by the `SET` command. These variables store information about internal constraints and it is possible to update them by contacting support:
