...
| `database_name`            | [`text`]                     | The value of the session's `database` variable at execution time.                                                                                                                                                                                                               |
| `search_path`              | [`text list`]                | The value of the session's `search_path` variable at execution time.                                                                                                                                                                                                               |
...
| `session_id`               | [`uuid`]                     | An ID that is unique for each session. Corresponds to [mz_sessions.id](https://materialize.com/docs/sql/system-catalog/mz_catalog/#mz_sessions). |
...
| Field                | Type                         | Meaning                                                                                                                           |
|----------------------|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| `id`                 | [`uuid`]                     | The globally unique ID of this history entry. Corresponds to [`mz_sessions.id`](#mz_sessions). |
...
| Field           | Type                           | Meaning                                                                                                                   |
| --------------- | ------------------------------ | --------                                                                                                                  |
| `id`            | [`uuid`]                       | The UUID of the session. Globally unique for all sessions. Corresponds to [`mz_recent_activity_log.session_id](#mz_recent_activity_log). |
