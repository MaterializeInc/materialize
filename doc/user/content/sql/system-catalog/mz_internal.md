...
| `error_message_redacted`   | [`text`]                     | The redacted error message, if the statement failed.                                                                                                                                                                                                                          |
...
| `error_message_redacted` | [`text`]                     | The redacted error returned when executing the statement, or `NULL` if it was successful, canceled or aborted.                                                                                                                                                                                             |
