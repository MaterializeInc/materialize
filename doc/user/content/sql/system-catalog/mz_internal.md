...
| `session_id`               | [`uuid`]                     | An ID that is unique for each session. Corresponds to [mz_sessions.uuid](https://materialize.com/docs/sql/system-catalog/mz_catalog/#mz_sessions). |
...
| `uuid`          | [`uuid`]                       | The UUID of the session. Corresponds to [`mz_recent_activity_log.session_id](#mz_recent_activity_log).                    |
