...
| `throttled_count`         | [`uint8`]                    | The number of statements that were dropped due to throttling before this one was seen. If you have a very high volume of queries and need to log them without throttling, please contact support.                                                                             |
