...
| `envelope_state_bytes` | [`bigint`]     | The esimated number of bytes stored in the source envelope state. Note, these are currently rough estimates and may not reflect the exact value.                                                                                                                                    |
