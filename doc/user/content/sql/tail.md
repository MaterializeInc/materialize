...
As an example, let's tail the [`mz_scheduling_elapsed`](/sql/system-catalog/mz_catalog/#mz_scheduling_elapsed) system table, which shows the total amount of time each worker spends in each dataflow.
