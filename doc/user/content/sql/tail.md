...
Progress messages communicate that no updates have occurred in a
given time window. These messages can be used to
distinguish between a stall in Materialize and a legitimate period of no updates.
