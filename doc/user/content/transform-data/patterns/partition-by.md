...
The option `PARTITION BY <column list>` declares that a [materialized view](/sql/create-materialized-view/#with_options) or [table](/sql/create-table/#syntax-summary) should be partitioned by the listed columns.
