...
PostgreSQL](https://cloud.google.com/sql/postgresql) to Materialize
using the[PostgreSQL source](/docs/sql/create-source/postgres/).
...
1.  Update your Google Cloud SQL firewall rules to allow traffic from
    Materialize IPs.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/ingest-data/postgres/cloud-sql.md"
class="btn-ghost"><img
