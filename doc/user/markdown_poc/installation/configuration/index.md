...
| Parameter | Default |
|----|----|
| [`balancerd.affinity`](#balancerdaffinity) | `nil` |
| [`balancerd.defaultResources`](#balancerddefaultresources) | `{"limits":{"memory":"256Mi"},"requests":{"cpu":"500m","memory":"256Mi"}}` |
| [`balancerd.enabled`](#balancerdenabled) | `true` |
| [`balancerd.nodeSelector`](#balancerdnodeselector) | `nil` |
| [`balancerd.tolerations`](#balancerdtolerations) | `nil` |
| [`clusterd.affinity`](#clusterdaffinity) | `nil` |
...
| [`clusterd.tolerations`](#clusterdtolerations) | `nil` |
| [`console.affinity`](#consoleaffinity) | `nil` |
| [`console.defaultResources`](#consoledefaultresources) | `{"limits":{"memory":"256Mi"},"requests":{"cpu":"500m","memory":"256Mi"}}` |
| [`console.enabled`](#consoleenabled) | `true` |
| [`console.imageTagMapOverride`](#consoleimagetagmapoverride) | `{}` |
| [`console.nodeSelector`](#consolenodeselector) | `nil` |
| [`console.tolerations`](#consoletolerations) | `nil` |
| [`environmentd.affinity`](#environmentdaffinity) | `nil` |
| [`environmentd.defaultResources`](#environmentddefaultresources) | `{"limits":{"memory":"4Gi"},"requests":{"cpu":"1","memory":"4095Mi"}}` |
| [`environmentd.nodeSelector`](#environmentdnodeselector) | `{}` |
| [`environmentd.tolerations`](#environmentdtolerations) | `nil` |
...
| [`operator.additionalMaterializeCRDColumns`](#operatoradditionalmaterializecrdcolumns) | `nil` |
| [`operator.affinity`](#operatoraffinity) | `nil` |
...
| [`operator.image.tag`](#operatorimagetag) | `"v26.1.0-rc.1"` |
| [`operator.nodeSelector`](#operatornodeselector) | `nil` |
...
| [`operator.tolerations`](#operatortolerations) | `nil` |
...
**Default**:
`{"limits":{"memory":"256Mi"},"requests":{"cpu":"500m","memory":"256Mi"}}`
...
**Default**:
`{"limits":{"memory":"4Gi"},"requests":{"cpu":"1","memory":"4095Mi"}}`
