...
| AWS Load Balancer Controller and Network Load Balancers for each Materialize instance | [v0.3.0+](/docs/installation/appendix-terraforms/#materialize-on-aws-terraform-module) |
| OpenEBS and NVMe instance storage to enable spill-to-disk | [v0.3.1+](/docs/installation/appendix-terraforms/#materialize-on-aws-terraform-module) |
| `cert-manager` and a self-signed `ClusterIssuer`. `ClusterIssuer` is deployed on subsequent runs after the `cert-manager` is running. | [v0.4.0+](/docs/installation/appendix-terraforms/#materialize-on-aws-terraform-module) |
...
configuration](/docs/installation/install-on-aws/appendix-aws-configuration/).
...
5.  Clone your forked repo and checkout the `v0.6.4` tag. For example,
    ...
    - If cloning via SSH (replace `YOUR_ORGANIZATION` with your
      ...
      ``` chroma
      git clone --depth 1 -b v0.6.4 git@github.com:${MY_ORGANIZATION}/terraform-aws-materialize.git
      ```
    ...
    - If cloning via HTTPS (replace `YOUR_ORGANIZATION` with your
      ...
      ``` chroma
      git clone --depth 1 -b v0.6.4 https://github.com/${MY_ORGANIZATION}/terraform-aws-materialize.git
      ```
...
14. Once the Materialize operator is deployed and running, you can
    ...
    **💡 Tip:**
    ...
    releases](/docs/installation/appendix-terraforms/#materialize-on-aws-terraform-module)
    for notable changes.
