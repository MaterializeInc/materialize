...
| Load balancers for each Materialize instance | [v0.3.0+](/docs/installation/appendix-terraforms/#materialize-on-gcp-terraform-module) |
| `cert-manager` and a self-signed `ClusterIssuer`. `ClusterIssuer` is deployed on subsequent runs after the `cert-manager` is running. | [v0.3.0+](/docs/installation/appendix-terraforms/#materialize-on-gcp-terraform-module) |
| OpenEBS and NVMe instance storage to enable spill-to-disk | [v0.4.0+](/docs/installation/appendix-terraforms/#materialize-on-gcp-terraform-module) |
...
configuration](/docs/installation/install-on-gcp/appendix-gcp-configuration/).
...
3.  Clone your forked repo and checkout the `v0.6.4` tag. For example,
    ...
    - If cloning via SSH:
      ...
      ``` chroma
      git clone --depth 1 -b v0.6.4 git@github.com:${MY_ORGANIZATION}/terraform-google-materialize.git
      ```
    ...
    - If cloning via HTTPS:
      ...
      ``` chroma
      git clone --depth 1 -b v0.6.4 https://github.com/${MY_ORGANIZATION}/terraform-google-materialize.git
      ```
