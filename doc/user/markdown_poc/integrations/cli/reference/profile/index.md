...
The `mz profile` command manages [authentication
profiles](../../configuration/#authentication-profiles) for `mz`.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/integrations/cli/reference/profile.md"
class="btn-ghost"><img
