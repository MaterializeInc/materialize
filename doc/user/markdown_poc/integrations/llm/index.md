...
You must create at least one [index](/docs/concepts/indexes/) on the
view. The columns in the index define the required input fields for the
tool.
...
- [COMMENT ON](/docs/sql/comment-on)
