...
`mz-debug` is a command-line interface tool that collects debug
information for self-managed and emulator Materialize environments. By
default, the tool creates a compressed file (`.zip`) containing logs and
a dump of the system catalog. You can then share this file with support
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/integrations/mz-debug/_index.md"
class="btn-ghost"><img
