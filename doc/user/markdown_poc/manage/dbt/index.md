...
with any other database that requires a non-native adapter.
...
- [Blue-green deployment
  guide](/docs/manage/dbt/blue-green-deployments/)

- [Slim deployment guide](/docs/manage/dbt/slim-deployments/)
...
`dbt-materialize` adapter does not expose all Materialize objects types.
If there is a **clear separation** between data modeling and
**infrastructure management ownership** in your team, and you want to
manage objects like [clusters](/docs/concepts/clusters/),
[connections](/docs/sql/create-connection/), or
[secrets](/docs/sql/create-secret/) as code, we recommend using the
[Materialize Terraform provider](/docs/manage/terraform/) as a
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/manage/dbt/_index.md"
class="btn-ghost"><img
