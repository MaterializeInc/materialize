...
| Field | Use |
|----|----|
| *query* | The [`SELECT`](/docs/sql/select) or [`SUBSCRIBE`](/docs/sql/subscribe) query to output results for. |
...
| Field | Use |
|----|----|
| *query* | The [`SELECT`](/docs/sql/select) query to copy results out for. |
| *object_name* | The name of the object to copy results out for. |
| **AWS CONNECTION** *connection_name* | The name of the AWS connection to use in the `COPY TO` command. For details on creating connections, check the [`CREATE CONNECTION`](/docs/sql/create-connection/#aws) documentation page. |
...
team](/docs/support/) or [open a bug
