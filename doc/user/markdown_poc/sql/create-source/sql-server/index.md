...
href="/docs/sql/create-connection/#sql-server"><code>CREATE CONNECTION</code></a>
...
| Field | Type | Details |
|----|----|----|
| `lsn` | [`bytea`](/docs/sql/types/bytea/) | The upper-bound [Log Sequence Number](https://learn.microsoft.com/en-us/sql/relational-databases/sql-server-transaction-log-architecture-and-management-guide) replicated thus far into Materialize. |
...
check the [`CREATE CONNECTION`](/docs/sql/create-connection/#sql-server)
documentation page.
...
SQL Server
Instructions](/docs/ingest-data/sql-server/self-hosted/#a-configure-sql-server).
