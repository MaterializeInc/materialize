...
|----|----|----|
| *str* | [`string`](../../types/string) | The base string. |
| *start_pos* | [`int`](../../types/int) | The starting position for the substring; counting starts at 1. |
| *len* | [`int`](../../types/int) | The length of the substring you want to return. |
