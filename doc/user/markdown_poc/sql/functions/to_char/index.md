...
specifiers](#format-specifiers), interspersed with regular text. You can
place a specifier token inside of double-quotes to emit it literally.
...
Normally the `W` in “Welcome” would be converted to the week number, so
we must quote it. The “to” doesn’t match any format specifiers, so
quotes are optional.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/functions/to_char.md"
class="btn-ghost"><img
