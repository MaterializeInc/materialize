...
`SHOW CLUSTER REPLICAS` lists the
[replicas](/docs/sql/create-cluster#replication-factor) for each cluster
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-cluster-replicas.md"
class="btn-ghost"><img
