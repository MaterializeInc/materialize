...
`SHOW CREATE CONNECTION` returns the DDL statement used to create the
connection.
...
For available connection names, see
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-create-connection.md"
class="btn-ghost"><img
