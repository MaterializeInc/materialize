...
`SHOW CREATE VIEW` returns the [`SELECT`](../select) statement used to
create the view.
...
For available view names, see [`SHOW VIEWS`](/docs/sql/show-views).
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-create-view.md"
class="btn-ghost"><img
