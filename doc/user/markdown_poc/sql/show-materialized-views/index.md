...
`SHOW MATERIALIZED VIEWS` returns a list of materialized views being
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-materialized-views.md"
class="btn-ghost"><img
