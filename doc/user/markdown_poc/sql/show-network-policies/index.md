...
`SHOW NETWORK POLICIES` returns a list of all network policies
configured in Materialize. Network policies are part of Materialize’s
framework for [access control](/docs/security/cloud/).
...
[`mz_internal.mz_network_policy_rules`](/docs/sql/system-catalog/mz_internal/#mz_network_policy_rules)
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-network-policies.md"
class="btn-ghost"><img
