...
`SHOW TYPES` returns a list of the data types in Materialize. Only
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-types.md"
class="btn-ghost"><img
