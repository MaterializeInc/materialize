...
- Allow [`EXPLAIN`](../sql/explain) statements to take parameters (`$1`, `$2`,
  etc).

- Avoid crashing when the number of query parameters in an execute command
  does not match the number of parameters declared in the query.
