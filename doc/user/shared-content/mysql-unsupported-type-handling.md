...
option](/sql/create-source-v1/mysql/#handling-unsupported-types) for the following
types:
...
use the [`EXCLUDE COLUMNS`](/sql/create-source-v1/mysql/#excluding-columns) option.
