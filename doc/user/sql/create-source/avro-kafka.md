...
**FORMAT** _format&lowbar;spec_ | The payload [format specification](#format-specification).
...
- If you are using the Confluent Schema Reigstry, Materialize looks for the key
