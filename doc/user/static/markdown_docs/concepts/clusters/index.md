...
When [creating a cluster](/docs/self-managed/v25.2/sql/create-cluster/),
you must choose its size (e.g., `25cc`, `50cc`, `100cc`), which
determines its resource allocation (CPU, memory, and scratch disk
space).
...
The appropriate size for a cluster depends on the resource requirements
of your workload. Larger clusters have more compute resources available
and can therefore process data faster and handle larger data volumes.

As your workload changes, you can [resize a
cluster](/docs/self-managed/v25.2/sql/alter-cluster/). Depending on the
type of objects in the cluster, this operation might incur downtime. See
[Resizing
downtime](/docs/self-managed/v25.2/sql/alter-cluster/#downtime) for more
details.
...
Console](/docs/self-managed/v25.2/console/monitoring/).
...
[Operational
guidelines](/docs/self-managed/v25.2/manage/operational-guidelines/).
...
- [System clusters](/docs/self-managed/v25.2/sql/system-clusters)
- [Usage](/docs/self-managed/v25.2/administration/usage/)
- [Operational
  guidelines](/docs/self-managed/v25.2/manage/operational-guidelines/)
