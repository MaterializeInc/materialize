...
**within a [cluster](/docs/self-managed/v25.2/concepts/clusters/)**. You
can create indexes on
[sources](/docs/self-managed/v25.2/concepts/sources/),
[views](/docs/self-managed/v25.2/concepts/views/#views), or
[materialized
...
[source](/docs/self-managed/v25.2/concepts/sources/) to maintain
in-memory up-to-date source data within the cluster you create the
index. This can help improve [query
performance](#indexes-and-query-optimizations) when serving results
directly from the source or when [using
joins](/docs/self-managed/v25.2/transform-data/optimization/#join).
However, in practice, you may find that you rarely need to index a
source directly.
...
In Materialize, you can create indexes on a
[view](/docs/self-managed/v25.2/concepts/views/#views "query
saved under a name") to maintain **up-to-date view results in memory**
within the [cluster](/docs/self-managed/v25.2/concepts/clusters/) you
create the index.
...
[view](/docs/self-managed/v25.2/concepts/views/#views "query saved under
...
**in memory** within the
[cluster](/docs/self-managed/v25.2/concepts/clusters/) you create the
index. That is, indexes on materialized views require no additional
...
[optimize query
performance](/docs/self-managed/v25.2/transform-data/optimization/),
such as:
