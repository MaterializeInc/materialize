...
- Real-time recency queries only guarantee visibility of data from
  ...
  [`LOAD GENERATOR`sources](/docs/self-managed/v25.2/sql/create-source/load-generator/)
...
selection](/docs/self-managed/v25.2/sql/functions/now_and_mz_now#logical-timestamp-selection).
