...
to consume these changefeed events into Materialize, making the data
...
1.  In the Console’s [SQL
    Shell](/docs/self-managed/v25.2/console/sql-shell/), or your
    ...
    A cluster of
    [size](/docs/self-managed/v25.2/sql/create-cluster/#size) `100cc`
    should be enough to accommodate multiple Kafka sources, depending on
    the source characteristics (e.g., sources with
...
refer to the
[`CREATE CONNECTION`](/docs/self-managed/v25.2/sql/create-connection/#kafka)
documentation for further guidance.

1.  In the [SQL Shell](/docs/self-managed/v25.2/console/), or your
    preferred SQL client connected to Materialize, use the
    [`CREATE SECRET`](/docs/self-managed/v25.2/sql/create-secret/)
    command to securely store the credentials to connect to your Kafka
    broker and, optionally, schema registry:
...
3.  Use the
    ...
    command to connect Materialize to your Kafka broker and start
    ingesting data from the target topic:
...
the observability features in the Materialize Console.

1.  In the Materialize Console
...
3.  For the duration of the snapshotting operation, the source status
    ...
    guide](/docs/self-managed/v25.2/ingest-data/troubleshooting/).
