...
[MySQL source](/docs/self-managed/v25.2/sql/create-source/mysql).
...
5.  In addition to the step above, you **must** also ensure that [binlog
    retention](/docs/self-managed/v25.2/sql/create-source/mysql/#binlog-retention)
    is set to a reasonable value. To check the current value of the
...
ingestion cluster, you can connect Materialize to your MySQL database
and start ingesting data. The exact steps depend on your networking
