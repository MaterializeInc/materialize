...
This page shows you how to stream data from [Google Cloud SQL for
MySQL](https://cloud.google.com/sql/MySQL) to Materialize using
the[MySQL source](/docs/sql/create-source/mysql/).
...
Before creating a source in Materialize, you **must** configure Google
Cloud SQL for MySQL for GTID-based binlog replication. Ensure the
...
For guidance on enabling GTID-based binlog replication in Cloud SQL, see
the [Cloud SQL
documentation](https://cloud.google.com/sql/docs/mysql/replication).
...
**NOTE:** If you are prototyping and your Google Cloud SQL instance is
...
2.  Update your Google Cloud SQL firewall rules to allow traffic from
    each IP address from the previous step.
...
3.  Update your Google Cloud SQL firewall rules to allow traffic from
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/ingest-data/mysql/google-cloud-sql.md"
class="btn-ghost"><img
