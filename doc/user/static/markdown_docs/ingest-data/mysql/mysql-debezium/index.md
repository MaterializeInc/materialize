...
[MySQL](/docs/self-managed/v25.2/sql/create-source/mysql/) source
instead.
...
to propagate CDC data from MySQL to Materialize in the unlikely event
that using the [native MySQL
source](/docs/self-managed/v25.2/sql/create-source/mysql/) is not an
