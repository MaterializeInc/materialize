...
[`CREATE SOURCE`](/docs/sql/create-source/kafka/) statements.
...
[`CREATE SOURCE`](/docs/sql/create-source/postgres/) statements:
...
You can reuse this MySQL connection across multiple
[`CREATE SOURCE`](/docs/sql/create-source/postgres/) statements.
...
- [`CREATE SOURCE`: MySQL](/docs/sql/create-source/mysql)
- [`CREATE SOURCE`: PostgreSQL](/docs/sql/create-source/postgres/)
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/ingest-data/network-security/ssh-tunnel.md"
class="btn-ghost"><img
