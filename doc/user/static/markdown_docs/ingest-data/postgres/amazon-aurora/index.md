...
[PostgreSQL source](/docs/sql/create-source/postgres/).
...
2.  In the AWS Management Console, [add an inbound rule to your Aurora
    security
...
3.  [Create a network load
    ...
    - For **Listeners and routing**, set the protocol and port to
      **TCP** and **5432** and select the target group you created in
      the previous step.
...
1.  In the [Materialize Console’s SQL Shell](/docs/console/), or your
    ...
    - Replace the `AVAILABILITY ZONES` list with the IDs of the
      availability zones in your AWS account.
