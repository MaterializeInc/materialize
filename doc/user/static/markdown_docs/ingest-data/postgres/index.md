...
[PostgreSQL
source](/docs/self-managed/v25.2/sql/create-source/postgres/) uses
PostgreSQL’s [replication
protocol](/docs/self-managed/v25.2/sql/create-source/postgres/#change-data-capture)
to **continually ingest changes** resulting from CRUD operations in the
...
<td><ul>
<li><a
href="/docs/self-managed/v25.2/ingest-data/postgres/alloydb/">AlloyDB
for PostgreSQL</a></li>
<li><a
href="/docs/self-managed/v25.2/ingest-data/postgres/amazon-aurora/">Amazon
Aurora for PostgreSQL</a></li>
<li><a
href="/docs/self-managed/v25.2/ingest-data/postgres/amazon-rds/">Amazon
RDS for PostgreSQL</a></li>
<li><a
href="/docs/self-managed/v25.2/ingest-data/postgres/azure-db/">Azure DB
for PostgreSQL</a></li>
<li><a
href="/docs/self-managed/v25.2/ingest-data/postgres/cloud-sql/">Google
Cloud SQL for PostgreSQL</a></li>
<li><a
href="/docs/self-managed/v25.2/ingest-data/postgres/neon/">Neon</a></li>
<li><a
href="/docs/self-managed/v25.2/ingest-data/postgres/self-hosted/">Self-hosted
PostgreSQL</a></li>
</ul></td>
</tr>
<tr>
...
If there is a hosted service or PostgreSQL distribution that is not
listed above but you would like to use with Materialize, please submit a
[feature
