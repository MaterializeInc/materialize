...
in the [Materialize console’s SQL
Shell](/docs/self-managed/v25.2/console/) or your preferred SQL client
...
Now that you’ve configured your database network and created an
ingestion cluster, you can connect Materialize to your Neon database and
...
3.  Use the
    ...
    command to connect Materialize to your Neon database and start
    ingesting data from the publication you created earlier:
