...
source](/docs/sql/create-source/kafka/#debezium-envelope) to propagate
CDC data from PostgreSQL to Materialize in the unlikely event that using
...
[Debezium envelope](/docs/sql/create-source/kafka/#debezium-envelope) in
Materialize:
