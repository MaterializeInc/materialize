...
3.  Use the
    ...
    command to connect Materialize to your database and start ingesting
    data from the publication you created
    [earlier](#2-create-a-publication-and-a-replication-user):
...
7.  Use the
    [`CREATE SOURCE`](/docs/self-managed/v25.2/sql/create-source/)
    command to connect Materialize to your Azure instance and start
...
8.  After source creation, you can handle upstream [schema
