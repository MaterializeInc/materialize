...
Server source](/docs/sql/create-source/sql-server/) uses SQL Server’s
change data capture feature to **continually ingest changes** resulting
from CRUD operations in the upstream database. The native support for
SQL Server Change Data Capture (CDC) in Materialize gives you the
following benefits:
...
- [Self-hosted SQL Server](/docs/ingest-data/sql-server/self-hosted/)
