...
data](/docs/self-managed/v25.2/ingest-data/)  /  [SQL
...
Source](/docs/self-managed/v25.2/sql/create-source/sql-server/).
...
1.  In the [SQL Shell](https://console.materialize.com/), or your
    ...
    your SQL Server database. For very large snapshots, consider using a
    ...
    changes being replicated from your upstream SQL Server database.
...
Materialize to your SQL Server database and start ingesting data. The
exact steps depend on your networking configuration, so start by
...
1.  In the [SQL Shell](https://console.materialize.com/), or your
    ...
    command to securely store the password for the SQL Server role
    you’ll use to replicate data into Materialize:
...
3.  Use the
    ...
    command to connect Materialize to your SQL Server instance and start
    ingesting data:
    ...
    - To handle unsupported data types, use the `TEXT COLUMNS` or
      ...
      documentation](/docs/self-managed/v25.2/sql/create-source/sql-server/#supported-types)
      for guidance.

4.  After source creation, you can handle upstream [schema
    changes](/docs/self-managed/v25.2/sql/create-source/sql-server/#schema-changes)
...
5.  Use the
    [`CREATE SECRET`](/docs/self-managed/v25.2/sql/create-secret/)
    command to securely store the password for the `materialize` SQL
    Server user [you
    created](#1-create-a-materialize-user-in-sql-server):
