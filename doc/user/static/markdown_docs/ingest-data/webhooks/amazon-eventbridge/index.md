...
must create a [secret](/docs/self-managed/v25.2/sql/create-secret/):
...
Materialize to ingest data from Amazon EventBridge. By default, the
source will be created in the active cluster; to use a different
...
rate](/docs/self-managed/v25.2/sql/create-source/webhook/#request-limits),
we recommend [batching multiple
events](/docs/self-managed/v25.2/sql/create-source/webhook/#handling-batch-events)
into a single request, for example using [EventBridge
