...
**! Important:** These VM types provide **ephemeral** local NVMe SSD
disks. Data is lost when the VM is stopped or deleted.
...
Starting in v0.4.0 of Materialize on Azure Terraform, disk support
(using OpenEBS and NVMe instance storage) is enabled, by default, for
...
- The following configuration options are available:
  ...
  - [`disk_support_config`](https://github.com/MaterializeInc/terraform-azurerm-materialize?tab=readme-ov-file#input_disk_support_config)
  - [`disk_setup_image`](https://github.com/MaterializeInc/terraform-azurerm-materialize?tab=readme-ov-file#input_disk_setup_image)

- The default
  [`aks_config.vm_size`](https://github.com/MaterializeInc/terraform-azurerm-materialize?tab=readme-ov-file#input_aks_config)
  has changed from `Standard_E8ps_v6` to `Standard_E4pds_v6`. See
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/installation/install-on-azure/appendix-deployment-guidelines.md"
class="btn-ghost"><img
