...
PostgreSQL as a metadata database; and blob storage; specifically
**block** blob storage on Azure.
...
| `cert-manager` and a self-signed `ClusterIssuer`. `ClusterIssuer` is deployed on subsequent runs after the `cert-manager` is running. | [v0.3.0+](/docs/self-managed/v25.2/installation/appendix-terraforms/#materialize-on-azure-terraform-module) |
| Load balancers for each Materialize instance | [v0.3.1+](/docs/self-managed/v25.2/installation/appendix-terraforms/#materialize-on-azure-terraform-module) |
| OpenEBS and NVMe instance storage to enable spill-to-disk | [v0.4.0+](/docs/self-managed/v25.2/installation/appendix-terraforms/#materialize-on-azure-terraform-module) |
...
configuration](/docs/self-managed/v25.2/installation/install-on-azure/appendix-azure-configuration/).
...
4.  Clone your forked repo and checkout the `v0.5.10` tag. For example,
    ...
    - If cloning via SSH (substitute `YOUR_ORGANIZATION` with your
      ...
      ``` chroma
      git clone --depth 1 -b v0.5.10 git@github.com:${MY_ORGANIZATION}/terraform-azurerm-materialize.git
      ```
    ...
    - If cloning via HTTPS (substitute `YOUR_ORGANIZATION` with your
      ...
      ``` chroma
      git clone --depth 1 -b v0.5.10 https://github.com/${MY_ORGANIZATION}/terraform-azurerm-materialize.git
      ```
...
14. Once the Materialize operator is deployed and running, you can
    ...
    **💡 Tip:**
    ...
    releases](/docs/self-managed/v25.2/installation/appendix-terraforms/#materialize-on-azure-terraform-module)
    for notable changes.
