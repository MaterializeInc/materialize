...
Azure](/docs/self-managed/v25.2/installation/install-on-azure/) (either
from the examples/simple directory or the root).
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/installation/install-on-azure/upgrade-on-azure.md"
class="btn-ghost"><img
