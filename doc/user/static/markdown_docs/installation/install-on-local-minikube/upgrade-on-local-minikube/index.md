...
The tutorial assumes you have installed Materialize on `minikube` using
the instructions on [Install locally on
minikube](/docs/self-managed/v25.2/installation/install-on-local-minikube/).
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/installation/install-on-local-minikube/upgrade-on-local-minikube.md"
class="btn-ghost"><img
