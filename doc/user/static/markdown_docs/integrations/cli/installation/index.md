...
Materialize CLI](/docs/self-managed/v25.2/integrations/cli/)
...
You’ll need [Homebrew](https://brew.sh) installed on your system. Then
install `mz` from [our
tap](https://github.com/MaterializeInc/homebrew-materialize):
...
You can use the `materialize/mz` Docker image to run `mz` on any
platform that is supported by Docker. You’ll need to mount your local
`~/.mz` directory in the container to ensure that configuration settings
and authentiation tokens outlive the container.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/integrations/cli/installation.md"
class="btn-ghost"><img
