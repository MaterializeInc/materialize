...
- Does not support statements whose semantics rely on sessions or whose
  ...
  - `FETCH`
  - `SUBSCRIBE`
- Supports specifying run-time [configuration
  parameters](/docs/self-managed/v25.2/sql/set) via URL query
  parameters.
...
this interface:
[environmentd-openapi.yml](/docs/self-managed/v25.2/materialize-openapi.yml).
