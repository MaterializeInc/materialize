...
- `USAGE` on all built-in types and [all system catalog
  schemas](/docs/self-managed/v25.2/sql/system-catalog/).
- `SELECT` on [system catalog
  objects](/docs/self-managed/v25.2/sql/system-catalog/).
- All [applicable
  privileges](/docs/self-managed/v25.2/manage/access-control/appendix-privileges/)
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/manage/access-control/_index.md"
class="btn-ghost"><img
