...
Terraform](/docs/self-managed/v25.2/manage/terraform/) instead.
...
limitations](/docs/self-managed/v25.2/transform-data/troubleshooting/#result-filtering)
in Materialize.
...
**NOTE:** Complex types like
[`map`](/docs/self-managed/v25.2/sql/types/map/) and
[`list`](/docs/self-managed/v25.2/sql/types/list/) are not supported in
unit tests yet (see [`dbt-adapters`
