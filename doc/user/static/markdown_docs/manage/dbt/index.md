...
- [Blue-green deployment
  guide](/docs/self-managed/v25.2/manage/dbt/blue-green-deployments/)

- [Slim deployment
  guide](/docs/self-managed/v25.2/manage/dbt/slim-deployments/)
...
[connections](/docs/self-managed/v25.2/sql/create-connection/), or
[secrets](/docs/self-managed/v25.2/sql/create-secret/) as code, we
recommend using the [Materialize Terraform
provider](/docs/self-managed/v25.2/manage/terraform/) as a complementary
deployment tool.
