...
4.  Add a Prometheus data source. In the Grafana UI, under **Connection
    ...
    user](/docs/self-managed/v25.2/images/grafana-prometheus-datasource-setup.png)
...
6.  [Import the dashboards using the Prometheus data
    ...
    ![Image of Materialize Console login screen with mz_system
    user](/docs/self-managed/v25.2/images/grafana-monitoring-success.png)
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/manage/monitor/prometheus.md"
class="btn-ghost"><img
