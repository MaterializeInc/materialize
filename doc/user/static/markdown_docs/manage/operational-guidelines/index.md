...
cluster(s), Serving
cluster(s)](/docs/self-managed/v25.2/images/3-tier-architecture.svg "3-tier
architecture")
...
<ul>
<li><p><a
href="/docs/self-managed/v25.2/concepts/views/#materialized-views">Materialized
...
href="/docs/self-managed/v25.2/transform-data/optimization/#optimize-multi-way-joins-with-delta-joins">indexes
on join keys</a>).</p>
<div class="tip">
...
href="/docs/self-managed/v25.2/concepts/indexes/">indexes</a> on the
materialized views. Indexes are local to the cluster in which they are
created.</td>
</tr>
</tbody>
</table>
...
If a three-tier architecture is infeasible or unnecessary due to low
volume or a non-production setup, a two cluster or a single cluster
architecture may suffice.

See [Appendix: Alternative cluster
architectures](/docs/self-managed/v25.2/manage/appendix-alternative-cluster-architectures/)
for details.
...
[sources](/docs/self-managed/v25.2/concepts/sources/); i.e., avoid
putting sources on the same cluster that hosts compute objects, sinks,
...
- For upsert sources, snapshotting is a resource-intensive operation
  that can require a significant amount of CPU and memory.

- During hydration (both initial and subsequent rehydrations),
  materialized views require memory proportional to both the input and
  output. When estimating required resources, consider both the
...
roles](/docs/self-managed/v25.2/manage/access-control/manage-roles).
...
system](/docs/self-managed/v25.2/manage/access-control/manage-roles/#show-roles-in-system)
and [Drop a
role](/docs/self-managed/v25.2/manage/access-control/manage-roles/#drop-a-role)
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/manage/operational-guidelines.md"
class="btn-ghost"><img
