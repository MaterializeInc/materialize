...
- You should be familiar with setting up a [Terraform project in
  Materialize](/docs/manage/terraform/).
...
- [`GRANT ROLE`](/docs/sql/grant-role/)
- [`CREATE ROLE`](/docs/sql/create-role/)
- [`GRANT PRIVILEGE`](/docs/sql/grant-privilege/)
- [`ALTER ROLE`](/docs/sql/alter-role/)
- [`REVOKE PRIVILEGE`](/docs/sql/revoke-privilege/)
- [`DROP ROLE`](/docs/sql/drop-role/)
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/manage/terraform/manage-rbac.md"
class="btn-ghost"><img
