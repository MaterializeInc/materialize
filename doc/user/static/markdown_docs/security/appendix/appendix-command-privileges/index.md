...
connection is namespaced by a schema.</li>
</ul></li>
</ul></td>
</tr>
<tr>
...
<li>Role membership in <code>new_owner</code>.</li>
<li><code>CREATE</code> privileges on the containing schema if the
materialized view is namespaced by a schema.</li>
</ul></li>
</ul></td>
</tr>
<tr>
...
<li>Role membership in <code>new_owner</code>.</li>
<li><code>CREATE</code> privileges on the containing schema if the
secret is namespaced by a schema.</li>
</ul></li>
</ul></td>
</tr>
<tr>
...
<ul>
<li>Role membership in <code>new_owner</code>.</li>
<li><code>CREATE</code> privileges on the containing schema if the sink
is namespaced by a schema.</li>
</ul></li>
</ul></li>
</ul></td>
</tr>
...
<li>Role membership in <code>new_owner</code>.</li>
<li><code>CREATE</code> privileges on the containing schema if the
source is namespaced by a schema.</li>
</ul></li>
</ul></td>
</tr>
<tr>
...
<ul>
<li>Role membership in <code>new_owner</code>.</li>
<li><code>CREATE</code> privileges on the containing schema if the table
is namespaced by a schema.</li>
</ul></li>
</ul></td>
</tr>
...
<ul>
<li>Role membership in <code>new_owner</code>.</li>
<li><code>CREATE</code> privileges on the containing schema if the type
is namespaced by a schema.</li>
</ul></li>
</ul></td>
</tr>
...
<ul>
<li>Role membership in <code>new_owner</code>.</li>
<li><code>CREATE</code> privileges on the containing schema if the view
is namespaced by a schema.</li>
</ul></li>
</ul></td>
</tr>
