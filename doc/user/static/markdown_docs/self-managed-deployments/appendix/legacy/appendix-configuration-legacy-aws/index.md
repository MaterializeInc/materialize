...
Terraform
modules](https://github.com/MaterializeInc/terraform-aws-materialize):
...
<pre class="chroma" tabindex="0"><code>namespace = &lt;string&gt;</code></pre>
</div></td>
</tr>
<tr>
<td><div class="highlight">
<pre class="chroma" tabindex="0"><code>environment = &lt;string&gt;</code></pre>
</div></td>
</tr>
<tr>
<td><div class="highlight">
<pre class="chroma" tabindex="0"><code>database_password =  &lt;string&gt;</code></pre>
</div></td>
</tr>
</tbody>
</table>
...
v0.3.0](https://github.com/MaterializeInc/terraform-aws-materialize),
you need to declare the following providers:
...
Starting in v0.6.1 of Materialize on AWS Terraform, disk support (using
swap on NVMe instance storage) may be enabled for Materialize. With this
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/appendix/legacy/appendix-configuration-legacy-aws.md"
class="btn-ghost"><img
