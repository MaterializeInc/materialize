...
8.  Install the Materialize Helm chart.
...
9.  Install PostgreSQL and MinIO.
...
10. Install the metrics service to the `kube-system` namespace.
...
11. Install Materialize into a new `materialize-environment` namespace:
    ...
    2.  Verify the installation and check the status:
        ...
        If you run into an error during deployment, refer to the
        [Troubleshooting](/docs/self-hosted/troubleshooting) guide.

12. Open the Materialize Console in your browser:
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/installation/install-on-local-kind.md"
class="btn-ghost"><img
