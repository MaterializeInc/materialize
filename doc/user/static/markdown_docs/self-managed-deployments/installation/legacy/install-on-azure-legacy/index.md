...
| `cert-manager` and a self-signed `ClusterIssuer`. `ClusterIssuer` is deployed on subsequent runs after the `cert-manager` is running. | [v0.3.0+](/docs/self-managed-deployments/appendix/legacy/appendix-legacy-terraform-releases/#materialize-on-azure-terraform-module) |
| Load balancers for each Materialize instance | [v0.3.1+](/docs/self-managed-deployments/appendix/legacy/appendix-legacy-terraform-releases/#materialize-on-azure-terraform-module) |
| OpenEBS and NVMe instance storage to enable spill-to-disk | [v0.4.0+](/docs/self-managed-deployments/appendix/legacy/appendix-legacy-terraform-releases/#materialize-on-azure-terraform-module) |
...
configuration](/docs/self-managed-deployments/appendix/legacy/appendix-configuration-legacy-azure/).
...
4.  Clone your forked repo and checkout the `v0.8.8` tag. For example,
    ...
    - If cloning via SSH (substitute `YOUR_ORGANIZATION` with your
      ...
      ``` chroma
      git clone --depth 1 -b v0.8.8 git@github.com:${MY_ORGANIZATION}/terraform-azurerm-materialize.git
      ```
    ...
    - If cloning via HTTPS (substitute `YOUR_ORGANIZATION` with your
      ...
      ``` chroma
      git clone --depth 1 -b v0.8.8 https://github.com/${MY_ORGANIZATION}/terraform-azurerm-materialize.git
      ```
...
14. Once the Materialize operator is deployed and running, you can
    ...
    **💡 Tip:**
    ...
    releases](/docs/self-managed-deployments/appendix/legacy/appendix-legacy-terraform-releases/#materialize-on-azure-terraform-module)
    for notable changes.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/installation/legacy/install-on-azure-legacy.md"
class="btn-ghost"><img
