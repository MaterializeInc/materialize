...
| Load balancers for each Materialize instance | [v0.3.0+](/docs/self-managed-deployments/appendix/legacy/appendix-legacy-terraform-releases/#materialize-on-gcp-terraform-module) |
| `cert-manager` and a self-signed `ClusterIssuer`. `ClusterIssuer` is deployed on subsequent runs after the `cert-manager` is running. | [v0.3.0+](/docs/self-managed-deployments/appendix/legacy/appendix-legacy-terraform-releases/#materialize-on-gcp-terraform-module) |
| OpenEBS and NVMe instance storage to enable spill-to-disk | [v0.4.0+](/docs/self-managed-deployments/appendix/legacy/appendix-legacy-terraform-releases/#materialize-on-gcp-terraform-module) |
...
configuration](/docs/self-managed-deployments/appendix/legacy/appendix-configuration-legacy-gcp/).
...
3.  Clone your forked repo and checkout the `v0.8.9` tag. For example,
    ...
    - If cloning via SSH:
      ...
      ``` chroma
      git clone --depth 1 -b v0.8.9 git@github.com:${MY_ORGANIZATION}/terraform-google-materialize.git
      ```
    ...
    - If cloning via HTTPS:
      ...
      ``` chroma
      git clone --depth 1 -b v0.8.9 https://github.com/${MY_ORGANIZATION}/terraform-google-materialize.git
      ```
...
11. Once the Materialize operator is deployed and running, you can
    ...
    **💡 Tip:**
    ...
    releases](/docs/self-managed-deployments/appendix/legacy/appendix-legacy-terraform-releases/#materialize-on-gcp-terraform-module)
    for notable changes.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/installation/legacy/install-on-gcp-legacy.md"
class="btn-ghost"><img
