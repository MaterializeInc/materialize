...
| Parameter | Default |
|----|----|
| [`balancerd.affinity`](#balancerdaffinity) | `{}` |
| [`balancerd.defaultResources.limits`](#balancerddefaultresourceslimits) | `{"memory":"256Mi"}` |
| [`balancerd.defaultResources.requests`](#balancerddefaultresourcesrequests) | `{"cpu":"500m","memory":"256Mi"}` |
| [`balancerd.enabled`](#balancerdenabled) | `true` |
| [`balancerd.nodeSelector`](#balancerdnodeselector) | `{}` |
| [`balancerd.tolerations`](#balancerdtolerations) | `{}` |
| [`clusterd.affinity`](#clusterdaffinity) | `{}` |
| [`clusterd.nodeSelector`](#clusterdnodeselector) | `{}` |
| [`clusterd.scratchfsNodeSelector`](#clusterdscratchfsnodeselector) | `{"materialize.cloud/scratch-fs":"true"}` |
| [`clusterd.swapNodeSelector`](#clusterdswapnodeselector) | `{"materialize.cloud/swap":"true"}` |
| [`clusterd.tolerations`](#clusterdtolerations) | `{}` |
| [`console.affinity`](#consoleaffinity) | `{}` |
| [`console.defaultResources.limits`](#consoledefaultresourceslimits) | `{"memory":"256Mi"}` |
| [`console.defaultResources.requests`](#consoledefaultresourcesrequests) | `{"cpu":"500m","memory":"256Mi"}` |
...
| [`console.tolerations`](#consoletolerations) | `{}` |
| [`environmentd.affinity`](#environmentdaffinity) | `{}` |
| [`environmentd.defaultResources.limits`](#environmentddefaultresourceslimits) | `{"memory":"4Gi"}` |
| [`environmentd.defaultResources.requests`](#environmentddefaultresourcesrequests) | `{"cpu":"1","memory":"4095Mi"}` |
| [`environmentd.nodeSelector`](#environmentdnodeselector) | `{}` |
| [`environmentd.tolerations`](#environmentdtolerations) | `{}` |
| [`networkPolicies.egress.cidrs`](#networkpoliciesegresscidrs) | `["0.0.0.0/0"]` |
| [`networkPolicies.egress.enabled`](#networkpoliciesegressenabled) | `false` |
| [`networkPolicies.enabled`](#networkpoliciesenabled) | `false` |
| [`networkPolicies.ingress.cidrs`](#networkpoliciesingresscidrs) | `["0.0.0.0/0"]` |
| [`networkPolicies.ingress.enabled`](#networkpoliciesingressenabled) | `false` |
| [`networkPolicies.internal.enabled`](#networkpoliciesinternalenabled) | `false` |
...
| [`operator.additionalMaterializeCRDColumns`](#operatoradditionalmaterializecrdcolumns) | `{}` |
...
| [`operator.args.enableLicenseKeyChecks`](#operatorargsenablelicensekeychecks) | `false` |
...
| [`operator.clusters.swap_enabled`](#operatorclustersswap_enabled) | `true` |
...
| [`operator.image.tag`](#operatorimagetag) | `"v26.6.0"` |
...
Default resource limits for balancerd’s CPU and memory if not set in the
Materialize CR
...
Default resources requested for balancerd’s CPU and memory if not set in
the Materialize CR
...
Additional node selector to use for clusterd pods when using an LVM
scratch disk. This will be merged with the values in `nodeSelector`.

#### clusterd.swapNodeSelector

**Default**: `{"materialize.cloud/swap":"true"}`

Additional node selector to use for clusterd pods when using swap. This
will be merged with the values in `nodeSelector`.
...
Default resource limits for the console’s CPU and memory if not set in
the Materialize CR
...
Default resources requested for the console’s CPU and memory if not set
in the Materialize CR
...
Default resource limits for environmentd’s CPU and memory if not set in
the Materialize CR

#### environmentd.defaultResources.requests

**Default**: `{"cpu":"1","memory":"4095Mi"}`

Default resources requested for environmentd’s CPU and memory if not set
in the Materialize CR
...
Whether to enable ingress network policies to the SQL and HTTP
interfaces on environmentd and balancerd

#### networkPolicies.internal.enabled

**Default**: `false`

Whether to enable network policies for internal communication between
Materialize pods
...
Additional columns to display when printing the Materialize CRD in table
format.
...
Configure sizes such that the pod QoS class is not Guaranteed, as is
required for swap to be enabled. Disk doesn’t make much sense with swap,
as swap performs better than lgalloc, so it also gets disabled.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/operator-configuration.md"
class="btn-ghost"><img
