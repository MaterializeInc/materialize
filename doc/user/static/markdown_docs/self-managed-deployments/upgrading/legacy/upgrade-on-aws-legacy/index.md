...
- To upgrade to `v26.0` using Materialize-provided Terraforms, upgrade
  your Terraform version to `v0.6.1` or higher, [AWS Terraform v0.6.1
  Upgrade
...
AWS](/docs/installation/install-on-aws/) (either from the
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/upgrading/legacy/upgrade-on-aws-legacy.md"
class="btn-ghost"><img
