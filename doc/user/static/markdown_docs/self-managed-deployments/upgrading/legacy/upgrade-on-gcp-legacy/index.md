...
GCP](/docs/self-managed-deployments/installation/legacy/install-on-gcp-legacy/)
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/upgrading/legacy/upgrade-on-gcp-legacy.md"
class="btn-ghost"><img
