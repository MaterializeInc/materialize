...
AWS Elastic Kubernetes Service (EKS). The tutorial assumes you have
installed the example on [Install on
AWS](/docs/self-managed-deployments/installation/install-on-aws/).
...
3.  Go to the Terraform directory for your Materialize deployment. For
    example, if you deployed from the `aws/examples/simple` directory:
...
4.  Ensure your AWS CLI is configured with the appropriate profile,
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/upgrading/upgrade-on-aws.md"
class="btn-ghost"><img
