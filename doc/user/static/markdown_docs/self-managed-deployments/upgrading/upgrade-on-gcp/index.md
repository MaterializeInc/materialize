...
Google Kubernetes Engine (GKE). The tutorial assumes you have installed
the example on [Install on
GCP](/docs/self-managed-deployments/installation/install-on-gcp/).
...
2.  Configure Google Cloud CLI with your GCP credentials. For details,
...
3.  Go to the Terraform directory for your Materialize deployment. For
    example, if you deployed from the `gcp/examples/simple` directory:
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/upgrading/upgrade-on-gcp.md"
class="btn-ghost"><img
