...
kind](/docs/self-managed-deployments/installation/install-on-local-kind/).
...
8.  Create a new `upgrade-materialize.yaml` file, updating the following
    fields:
    ...
    the operator version: <code>v26.6.0</code>.</td>
    </tr>
    <tr>
    ...
    spec:
      environmentdImageRef: materialize/environmentd:v26.6.0 # Update version
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/self-managed-deployments/upgrading/upgrade-on-kind.md"
class="btn-ghost"><img
