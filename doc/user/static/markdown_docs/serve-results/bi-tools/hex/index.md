...
results](/docs/self-managed/v25.2/serve-results/)  /  [Use BI/data
collaboration tools](/docs/self-managed/v25.2/serve-results/bi-tools/)
...
level](/docs/self-managed/v25.2/sql/alter-role) using the following SQL
statement:
