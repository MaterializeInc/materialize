...
statement](/docs/self-managed/v25.2/sql/select/). For example:
...
the active [cluster](/docs/self-managed/v25.2/concepts/clusters/), which
...
[`SELECT`](/docs/self-managed/v25.2/sql/select/) reference page. See
also the following client library guides:

[Go](/docs/self-managed/v25.2/integrations/client-libraries/golang/#query)

[Java](/docs/self-managed/v25.2/integrations/client-libraries/java-jdbc/#query)

[Node.js](/docs/self-managed/v25.2/integrations/client-libraries/node-js/#query)

[PHP](/docs/self-managed/v25.2/integrations/client-libraries/php/#query)

[Python](/docs/self-managed/v25.2/integrations/client-libraries/python/#query)

[Ruby](/docs/self-managed/v25.2/integrations/client-libraries/ruby/#query)

[Rust](/docs/self-managed/v25.2/integrations/client-libraries/rust/#query)

## SUBSCRIBE

You can use [`SUBSCRIBE`](/docs/self-managed/v25.2/sql/subscribe/) to
stream query results. For example:
...
The [`SUBSCRIBE`](/docs/self-managed/v25.2/sql/subscribe/) statement is
a more general form of a `SELECT` statement. While a `SELECT` statement
computes a relation at a moment in time, a `SUBSCRIBE` operation
computes how a relation changes over time.
...
For more information, see
[`SUBSCRIBE`](/docs/self-managed/v25.2/sql/subscribe/) reference page.
