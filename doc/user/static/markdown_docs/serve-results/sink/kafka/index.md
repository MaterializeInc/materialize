...
[connection options](/docs/sql/create-sink/kafka#syntax).
...
options](/docs/sql/create-sink/kafka#syntax) to set any relevant kafka
...
<td>Progress topic</td>
<td>Segment bytes.</td>
<td>Defaults to 128 MiB. We recommend going no higher than 256 MiB to
avoid</td>
</tr>
<tr>
<td>slow startups when creating new sinks, as they must process the
entire progress topic on startup.</td>
<td></td>
<td></td>
</tr>
<tr>
