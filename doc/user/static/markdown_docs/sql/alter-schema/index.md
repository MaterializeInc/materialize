...
<div id="tab-rename-schema" class="tab-pane" title="Rename schema">
...
To change the owner of a schema, you must be the owner of the schema and
...
Swapping two schemas is useful for a blue/green deployment. The
following swaps the names of the `blue` and `green` schemas.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/alter-schema.md"
class="btn-ghost"><img
