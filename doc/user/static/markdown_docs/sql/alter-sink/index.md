...
console](/docs/self-managed/v25.2/console/), or query the
[`mz_internal.mz_sink_statuses`](/docs/self-managed/v25.2/sql/system-catalog/mz_internal/#mz_sink_statuses)
system catalog view.
...
object](/docs/self-managed/v25.2/sql/system-catalog/). As a workaround,
...
`matview_old` (See
[`CREATE SINK`:Kafka/Redpanda](/docs/self-managed/v25.2/sql/create-sink/kafka/)
...
4.  Wait for the sink’s upper frontier
    ([`mz_frontiers`](/docs/self-managed/v25.2/sql/system-catalog/mz_internal/#mz_frontiers))
