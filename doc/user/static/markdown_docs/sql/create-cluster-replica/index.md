...
cluster](/docs/sql/create-cluster/#unmanaged-clusters).
...
<td>The cluster you want to attach a replica to.</td>
</tr>
<tr>
<td><code>&lt;replica_name&gt;</code></td>
<td>A name for this replica.</td>
</tr>
<tr>
...
<p>See <a href="#size">Size</a> for details as well as legacy sizes
available.</p></td>
</tr>
</tbody>
</table>
...
clusters](/docs/sql/create-cluster/#size) option, except that the size
...
- [`DROP CLUSTER REPLICA`](/docs/sql/drop-cluster-replica)
