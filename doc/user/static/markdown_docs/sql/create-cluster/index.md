...
See <a href="#replication-factor">Replication factor</a> for
details.</p>
...
<p><span id="unmanaged-clusters"></span></p>
<p>Specify <code>FALSE</code> to create an <strong>unmanaged</strong>
cluster. With unmanaged clusters, you need to manually manage the
cluster’s replicas using the the <a
...
<code>REPLICAS</code> option as well.</p>
<div class="tip">
...
<td><p>Optional. The <a href="#scheduling">scheduling type</a> for the
cluster. Valid values are:</p>
<ul>
<li><code>MANUAL</code></li>
<li><code>ON REFRESH</code></li>
</ul>
