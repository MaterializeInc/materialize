...
results](/docs/self-managed/v25.2/concepts/reaction-time) by persisting
them in durable storage and incrementally updating them as new data
arrives.
...
[Kafka](/docs/self-managed/v25.2/sql/create-sink). When you create a
materialized view, you specify a
[cluster](/docs/self-managed/v25.2/concepts/clusters/) responsible for
...
it](/docs/self-managed/v25.2/concepts/views/#views). In Materialize,
[indexes on views](/docs/self-managed/v25.2/concepts/indexes/) also
maintain results incrementally, but store them in memory, scoped to the
cluster where the index was created. This approach offers lower latency
for direct querying within that cluster.
...
href="/docs/self-managed/v25.2/transform-data/patterns/partition-by/">partitioning
...
[fresh](/docs/self-managed/v25.2/concepts/reaction-time) as the input
data itself.
...
clusters**](/docs/self-managed/v25.2/sql/create-cluster/#scheduling),
which can be configured to automatically [turn on ahead of the scheduled
refresh
time](/docs/self-managed/v25.2/sql/create-cluster/#hydration-time-estimate).
...
process known as
[*hydration*](/docs/self-managed/v25.2/transform-data/troubleshooting/#hydrating-upstream-objects)
