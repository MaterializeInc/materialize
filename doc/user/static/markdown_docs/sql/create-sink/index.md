...
A [sink](/docs/self-managed/v25.2/concepts/sinks/) describes an external
system you want Materialize to write data to, and provides details about
how to encode that data. You can define a sink over a materialized view,
source, or table.
...
- [Kafka/Redpanda](/docs/self-managed/v25.2/sql/create-sink/kafka)
...
connector, check out the dedicated `CREATE SINK` documentation pages.
...
- [Sinks](/docs/self-managed/v25.2/concepts/sinks/)
- [`SHOW SINKS`](/docs/self-managed/v25.2/sql/show-sinks/)
- [`SHOW COLUMNS`](/docs/self-managed/v25.2/sql/show-columns/)
- [`SHOW CREATE SINK`](/docs/self-managed/v25.2/sql/show-create-sink/)
