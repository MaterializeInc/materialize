...
href="/docs/self-managed/v25.2/sql/create-connection/#mysql"><code>CREATE CONNECTION</code></a>
...
RDS](/docs/self-managed/v25.2/ingest-data/mysql/amazon-rds/), [Amazon
Aurora](/docs/self-managed/v25.2/ingest-data/mysql/amazon-aurora/),
[Azure DB](/docs/self-managed/v25.2/ingest-data/mysql/azure-db/),
[Google Cloud
SQL](/docs/self-managed/v25.2/ingest-data/mysql/google-cloud-sql/),
[Self-hosted](/docs/self-managed/v25.2/ingest-data/mysql/self-hosted/).
...
MySQL](/docs/self-managed/v25.2/ingest-data/mysql/amazon-rds/) has its
own configuration parameter for binlog retention
...
MySQL source and want to replicate them to Materialize, the source must
...
| Field | Type | Details |
|----|----|----|
| `source_id_lower` | [`uuid`](/docs/self-managed/v25.2/sql/types/uuid/) | The lower-bound GTID `source_id` of the GTIDs covered by this range. |
| `source_id_upper` | [`uuid`](/docs/self-managed/v25.2/sql/types/uuid/) | The upper-bound GTID `source_id` of the GTIDs covered by this range. |
| `transaction_id` | [`uint8`](/docs/self-managed/v25.2/sql/types/uint/#uint8-info) | The `transaction_id` of the next GTID possible from the GTID `source_id`s covered by this range. |
...
- MySQL integration guides:
  - [Amazon RDS](/docs/self-managed/v25.2/ingest-data/mysql/amazon-rds/)
  - [Amazon
    Aurora](/docs/self-managed/v25.2/ingest-data/mysql/amazon-aurora/)
  - [Azure DB](/docs/self-managed/v25.2/ingest-data/mysql/azure-db/)
  - [Google Cloud
