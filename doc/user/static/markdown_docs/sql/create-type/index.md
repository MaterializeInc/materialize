...
`CREATE TYPE` defines a custom data type, which let you create named
versions of anonymous types or provide a shorthand for other types. For
more information, see [SQL Data Types: Custom
...
<div id="tab-row-type" class="tab-pane" title="Row type">
...
<div id="tab-list-type" class="tab-pane" title="List type">
...
|----|----|
| `<type_name>` | A name for the type. |
| `<element_type>` | Creates a custom [`list`](/docs/sql/types/list) whose elements are of `<element_type>`. |

</div>

<div id="tab-map-type" class="tab-pane" title="Map type">
...
|----|----|
| `<type_name>` | A name for the type. |
| `<key_type>` | Creates a custom [`map`](/docs/sql/types/map) whose keys are of `<key_type>`. Must resolve to [`text`](/docs/sql/types/text). |
| `<value_type>` | Creates a custom [`map`](/docs/sql/types/map) whose values are of `<value_type>`. |
