...
cannot create an [index](/docs/sql/create-index) or materialized view
that depends on an unmaterializable function, but you can use them in
non-materialized views and one-off [`SELECT`](/docs/sql/select)
statements.
...
<p><a href="/docs/sql/functions/cast">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/array_agg">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/jsonb_agg">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/jsonb_object_agg">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/string_agg">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/list_agg">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/map_agg">(docs)</a>.</p></td>
</tr>
</tbody>
</table>
...
<div class="highlight">
<pre class="chroma" tabindex="0"><code>ceil(x: N) -&gt; double precision</code></pre>
</div>
</div>
...
<div class="highlight">
<pre class="chroma" tabindex="0"><code>ceiling(x: N) -&gt; double precision</code></pre>
</div>
</div>
...
<div class="highlight">
<pre class="chroma" tabindex="0"><code>exp(x: N) -&gt; double precision</code></pre>
</div>
</div>
...
<div class="highlight">
<pre class="chroma" tabindex="0"><code>floor(x: N) -&gt; double precision</code></pre>
</div>
</div>
...
<div class="highlight">
<pre class="chroma" tabindex="0"><code>round(x: N) -&gt; double precision</code></pre>
</div>
</div>
...
<div class="highlight">
<pre class="chroma" tabindex="0"><code>trunc(x: N) -&gt; double precision</code></pre>
</div>
</div>
...
<div class="highlight">
<pre class="chroma" tabindex="0"><code>bit_count(b: bytea) -&gt; bigint</code></pre>
</div>
</div>
...
<p>Concatenates the text representation of non-NULL arguments. The
maximum length of the result string is 100 MiB.</p></td>
</tr>
<tr>
...
<code>f</code> and <code>r</code> separated by <code>sep</code>. The
maximum length of the result string is 100 MiB.</p></td>
</tr>
<tr>
...
<p>Decode <code>s</code> using the specified textual representation. The
maximum size of the result is 100 MiB.</p>
<p><a href="/docs/sql/functions/encode">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/length">(docs)</a>.</p></td>
</tr>
<tr>
<td><div id="length" class="heading docsearch_l3">
<div class="highlight">
...
<code>s</code>. The maximum length of the result string is 100
MiB.</p></td>
</tr>
<tr>
<td><div id="lpad" class="heading docsearch_l3">
...
less than the length of <code>s</code>. The maximum length of the result
string is 100 MiB.</p></td>
</tr>
<tr>
...
<tr>
<td><div id="normalize" class="heading docsearch_l3">
<div class="highlight">
<pre class="chroma" tabindex="0"><code>normalize(s: str) -&gt; str</code></pre>
</div>
</div>
<p>Normalize <code>s</code> to Unicode Normalization Form NFC
(default).</p>
<p><a href="/docs/sql/functions/normalize">(docs)</a>.</p></td>
</tr>
<tr>
<td><div id="normalize" class="heading docsearch_l3">
<div class="highlight">
<pre class="chroma" tabindex="0"><code>normalize(s: str, form: keyword) -&gt; str</code></pre>
</div>
</div>
<p>Normalize <code>s</code> to the specified Unicode normalization form
(NFC, NFD, NFKC, or NFKD).</p>
<p><a href="/docs/sql/functions/normalize">(docs)</a>.</p></td>
</tr>
<tr>
...
<div class="warning">
<strong>WARNING!</strong> This function has the potential to produce
very large strings and may cause queries to run out of memory or crash.
Use with caution.
</div>
...
<p>Replicate the string <code>n</code> times. The maximum length of the
result string is 100 MiB.</p></td>
</tr>
<tr>
...
<code>r</code>. The maximum length of the result string is 100
MiB.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/substring">(docs)</a>.</p></td>
</tr>
<tr>
<td><div id="substring" class="heading docsearch_l3">
<div class="highlight">
...
<p><a href="/docs/sql/functions/pushdown">(docs)</a>.</p></td>
</tr>
<tr>
...
href="/docs/transform-data/idiomatic-materialize-sql/any">idiomatic
...
Subquery functions take a query, e.g. [`SELECT`](/docs/sql/select)
...
<p><a href="/docs/sql/functions/csv_extract">(docs)</a>.</p></td>
</tr>
<tr>
...
<code>stride</code></p>
<p><a href="/docs/sql/functions/date-bin">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/date-trunc">(docs)</a>.</p></td>
</tr>
<tr>
<td><div id="date_trunc" class="heading docsearch_l3">
<div class="highlight">
...
<p><a href="/docs/sql/functions/extract">(docs)</a>.</p></td>
</tr>
<tr>
...
<p>Specified time component from value</p>
<p><a href="/docs/sql/functions/date-part">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/now_and_mz_now">(docs)</a>.</p>
<p><strong>Note:</strong> This function is <a
...
<p><a
href="/docs/sql/functions/timezone-and-at-time-zone">(docs)</a>.</p>
...
<p><a href="/docs/sql/functions/to_char">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/justify-days">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/functions/justify-hours">(docs)</a>.</p></td>
</tr>
<tr>
...
sign adjustments</p>
<p><a href="/docs/sql/functions/justify-interval">(docs)</a>.</p></td>
</tr>
</tbody>
</table>
...
object</p>
<p><a href="/docs/sql/types/jsonb#jsonb_each">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><code>j</code>’s outermost elements if <code>j</code> is an
object</p>
<p><a href="/docs/sql/types/jsonb#jsonb_each_text">(docs)</a>.</p></td>
</tr>
<tr>
<td><div id="jsonb_object_agg" class="heading docsearch_l3">
<div class="highlight">
...
<p><a href="/docs/sql/types/jsonb#jsonb_pretty">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/types/jsonb#jsonb_typeof">(docs)</a>.</p></td>
</tr>
<tr>
...
<p><a href="/docs/sql/types/jsonb#to_jsonb">(docs)</a>.</p></td>
</tr>
</tbody>
</table>
...
functions](/docs/sql/functions/table-functions).
...
SQL](/docs/transform-data/idiomatic-materialize-sql/) for details.
...
SQL](/docs/transform-data/idiomatic-materialize-sql/) for examples of
...
<p>See also <a
href="/docs/transform-data/idiomatic-materialize-sql/first-value/">Idiomatic
...
<p>See also <a
href="/docs/transform-data/idiomatic-materialize-sql/lag/">Idiomatic
...
<code>RANGE BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW</code>.</p>
<p>See also <a
href="/docs/transform-data/idiomatic-materialize-sql/last-value/">Idiomatic
...
<code>default</code> to <code>NULL</code>.</p>
<p>See also <a
href="/docs/transform-data/idiomatic-materialize-sql/lead/">Idiomatic
...
way.</p>
<p>See also <a
href="/docs/transform-data/idiomatic-materialize-sql/top-k/">Idiomatic
...
<p>Reports whether the <code>current_role</code> is a superuser.</p>
<p><strong>Note:</strong> This function is <a
href="#unmaterializable-functions">unmaterializable</a>.</p></td>
</tr>
</tbody>
...
the [Rust `regex` crate](https://docs.rs/regex/*/#syntax). The maximum
length of a regular expression is 1 MiB in its raw form, and 10 MiB
after compiling it.
