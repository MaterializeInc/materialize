...
each other. Use the [SQL Shell](/docs/console/) to run the sequence of
commands below.
...
[`SUBSCRIBE`](/docs/sql/subscribe/) to the materialized view and then
use a different SQL Shell session to insert some sample data into the
...
- [Regular CTEs](/docs/sql/select/#regular-ctes)
- [`SELECT`](/docs/sql/select)
