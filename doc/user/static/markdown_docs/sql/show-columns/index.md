...
`SHOW COLUMNS` lists the columns available for an object. This can be a
source, subsource, materialized view, view, or table.
...
Rows are sorted by the order in which the fields are defined in the
targeted object.
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-columns.md"
class="btn-ghost"><img
