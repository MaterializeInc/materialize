...
| Option | Description |
|----|----|
| **FROM** \<schema_name\> | If specified, only show connections from the specified schema. For available schema names, see [`SHOW SCHEMAS`](/docs/self-managed/v25.2/sql/show-schemas). |
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-connections.md"
class="btn-ghost"><img
