...
`SHOW CREATE CLUSTER` returns the DDL statement used to create the
cluster.
...
For available cluster names, see
[`SHOW CLUSTERS`](/docs/self-managed/v25.2/sql/show-clusters).
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-create-cluster.md"
class="btn-ghost"><img
