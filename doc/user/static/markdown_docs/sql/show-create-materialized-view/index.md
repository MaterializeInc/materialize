...
`SHOW CREATE MATERIALIZED VIEW` returns the DDL statement used to create
...
For available materialized view names, see
[`SHOW MATERIALIZED VIEWS`](/docs/self-managed/v25.2/sql/show-materialized-views).
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-create-materialized-view.md"
class="btn-ghost"><img
