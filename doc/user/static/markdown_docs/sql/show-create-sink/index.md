...
For available sink names, see [`SHOW SINKS`](/docs/sql/show-sinks).
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-create-sink.md"
class="btn-ghost"><img
