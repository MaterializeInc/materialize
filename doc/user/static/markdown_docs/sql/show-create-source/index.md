...
`SHOW CREATE SOURCE` returns the DDL statement used to create the
source.
...
For available source names, see
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-create-source.md"
class="btn-ghost"><img
