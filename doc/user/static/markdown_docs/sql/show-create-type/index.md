...
`SHOW CREATE TYPE` returns the DDL statement used to create the custom
type.
...
For available type names names, see
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-create-type.md"
class="btn-ghost"><img
