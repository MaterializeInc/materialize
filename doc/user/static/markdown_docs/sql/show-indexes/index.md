...
`SHOW INDEXES` provides details about indexes built on a source, view,
...
| **cluster** | The name of the [cluster](/docs/self-managed/v25.2/concepts/clusters/) containing the index. |
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show-indexes.md"
class="btn-ghost"><img
