...
`SHOW` displays the value of either a specified configuration parameter
or all configuration parameters.
...
- `schema`: an alias for showing the first resolvable schema in
  `search_path`
...
href="/docs/self-managed/v25.2/overview/isolation-level/">Consistency
guarantees</a>.<br />
<br />
...
<td><a href="/docs/self-managed/v25.2/support">Contact support</a></td>
</tr>
<tr>
...
href="/docs/self-managed/v25.2/get-started/isolation-level/#real-time-recency">real-time
...
<a
href="//github.com/MaterializeInc/materialize/edit/main/doc/user/content/sql/show.md"
class="btn-ghost"><img
