...
- If any value passed to a polymorphic parameter is a [custom
  type](/docs/self-managed/v25.2/sql/types/#custom-types), additional
  constraints apply.
...
types](/docs/self-managed/v25.2/sql/types/#custom-types), which lets you
...
[polymorphism](/docs/self-managed/v25.2/sql/types/#polymorphism).
