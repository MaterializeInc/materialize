...
type](/docs/self-managed/v25.2/sql/types#custom-types) and the other is
a [built-in map](/docs/self-managed/v25.2/sql/types#built-in-types) and
their key-value types are structurally equivalent.
