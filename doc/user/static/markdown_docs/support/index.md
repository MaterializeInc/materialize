...
**💡 Tip:** If you are an Enterprise customer with SLA support and are
experiencing an [**urgent**
issue](#urgent-issues-for-sla-supported-customers-only), you can use the
messenger’s **Report Production Outage** option for fastest response.
...
- Use the [messenger’s](#messenger-app) **Report Production
  Outage** option for fastest response.
