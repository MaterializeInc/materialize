...
 /  [Appendix](/docs/self-managed/v25.2/transform-data/idiomatic-materialize-sql/appendix/)
...
[`LEAD()`](/docs/self-managed/v25.2/sql/functions/#lead),
[`ROW_NUMBER()`](/docs/self-managed/v25.2/sql/functions/#row_number),
[`FIRST_VALUE()`](/docs/self-managed/v25.2/sql/functions/#first_value),
and [`LAST_VALUE()`](/docs/self-managed/v25.2/sql/functions/#last_value)
use cases, Materialize provides its own idiomatic query patterns that do
not use the window functions and can provide better performance.
