...
use [MIN()](/docs/self-managed/v25.2/sql/functions/#min) or
...
href="/docs/self-managed/v25.2/sql/functions/#first_value"><code>FIRST_VALUE() OVER (PARTITION BY ... ORDER BY ...)</code>
...
- [Last value in a
  group](/docs/self-managed/v25.2/transform-data/idiomatic-materialize-sql/last-value)
- [`MIN()`](/docs/self-managed/v25.2/sql/functions/#min)
- [`MAX()`](/docs/self-managed/v25.2/sql/functions/#max)
- [Query hints for
  MIN/MAX](/docs/self-managed/v25.2/transform-data/optimization/#query-hints)
- [Window
  functions](/docs/self-managed/v25.2/sql/functions/#window-functions)
