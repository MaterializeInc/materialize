...
complex queries to take longer to hydrate. For Cloud, you should also
expect hydration to be triggered every time a cluster is restarted or
sized up, including during [Materialize Cloud’s routine maintenance
window](/docs/releases/schedule/#cloud-upgrade-schedule).
