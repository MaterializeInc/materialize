...
appVersion: v0.146.5  # Use this version for your Materialize instances
```

Use the `appVersion` (`v0.146.5` in this case) when updating your Materialize instances to ensure compatibility.
...
kubectl patch materialize <instance-name> \
  ...
  --type='merge' \
  -p "{\"spec\": {\"environmentdImageRef\": \"materialize/environmentd:v0.146.5\"}}"
...
kubectl patch materialize 12345678-1234-1234-1234-123456789012 \
  ...
  --type='merge' \
  -p "{\"spec\": {\"environmentdImageRef\": \"materialize/environmentd:v0.146.5\", \"requestRollout\": \"$(uuidgen)\"}}"
```
...
metadata:
  ...
  namespace: materialize-environment
spec:
  environmentdImageRef: materialize/environmentd:v0.146.5 # Update version as needed
