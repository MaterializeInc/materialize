...
helm install my-materialize-operator \
  --set operator.image.tag=v0.158.0-dev.0 \
...
metadata:
  ...
  namespace: materialize-environment
spec:
  environmentdImageRef: materialize/environmentd:v0.158.0-dev.0
