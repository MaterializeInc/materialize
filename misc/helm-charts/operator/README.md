...
![Version: v25.3.0-beta.1](https://img.shields.io/badge/Version-v25.3.0--beta.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.154.0-dev.0](https://img.shields.io/badge/AppVersion-v0.154.0--dev.0-informational?style=flat-square)
...
helm install my-materialize-operator \
  --set operator.image.tag=v0.154.0-dev.0 \
