...
![Version: v25.1.0](https://img.shields.io/badge/Version-v25.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.130.1](https://img.shields.io/badge/AppVersion-v0.130.1-informational?style=flat-square)
...
| `operator.image.tag` | The tag/version of the operator image to be used | ``"v0.130.1"`` |
...
# ...
version: v25.1.0
appVersion: v0.130.1  # Use this version for your Materialize instances
```
