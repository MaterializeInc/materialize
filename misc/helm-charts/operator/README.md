...
![Version: v25.1.3](https://img.shields.io/badge/Version-v25.1.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.130.6](https://img.shields.io/badge/AppVersion-v0.130.6-informational?style=flat-square)
...
| `operator.image.tag` | The tag/version of the operator image to be used | ``"v0.130.6"`` |
...
helm install my-materialize-operator \
  --set operator.image.tag=v0.130.6 \
...
metadata:
  ...
  namespace: materialize-environment
spec:
  environmentdImageRef: materialize/environmentd:v0.130.6
...
# ...
version: v25.1.2
appVersion: v0.130.4  # Use this version for your Materialize instances
```

Use the `appVersion` (`v0.130.4` in this case) when updating your Materialize instances to ensure compatibility.
...
kubectl patch materialize <instance-name> \
  ...
  --type='merge' \
  -p "{\"spec\": {\"environmentdImageRef\": \"materialize/environmentd:v0.130.4\"}}"
...
kubectl patch materialize 12345678-1234-1234-1234-123456789012 \
  ...
  --type='merge' \
  -p "{\"spec\": {\"environmentdImageRef\": \"materialize/environmentd:v0.130.4\", \"requestRollout\": \"$(uuidgen)\"}}"
```
...
metadata:
  ...
  namespace: materialize-environment
spec:
  environmentdImageRef: materialize/environmentd:v0.130.4 # Update version as needed
