...
| `operator.clusters.sizes.2xlarge.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.2xsmall.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.3xlarge.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.3xsmall.cpu_exclusive` |  | ``false`` |
...
| `operator.clusters.sizes.4xlarge.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.5xlarge.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.6xlarge.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.large.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.medium.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.small.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.xlarge.cpu_exclusive` |  | ``true`` |
...
| `operator.clusters.sizes.xsmall.cpu_exclusive` |  | ``true`` |
