...
![Version: v25.3.0-beta.1](https://img.shields.io/badge/Version-v25.3.0--beta.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.143.0-dev.0](https://img.shields.io/badge/AppVersion-v0.143.0--dev.0-informational?style=flat-square)
...
| `operator.image.tag` | The tag/version of the operator image to be used | ``"v0.142.1"`` |
...
helm install my-materialize-operator \
  --set operator.image.tag=v0.143.0-dev.0 \
...
metadata:
  ...
  namespace: materialize-environment
spec:
  environmentdImageRef: materialize/environmentd:v0.143.0-dev.0
...
appVersion: v0.142.1  # Use this version for your Materialize instances
```

Use the `appVersion` (`v0.142.1` in this case) when updating your Materialize instances to ensure compatibility.
...
kubectl patch materialize <instance-name> \
  ...
  --type='merge' \
  -p "{\"spec\": {\"environmentdImageRef\": \"materialize/environmentd:v0.142.1\"}}"
...
kubectl patch materialize 12345678-1234-1234-1234-123456789012 \
  ...
  --type='merge' \
  -p "{\"spec\": {\"environmentdImageRef\": \"materialize/environmentd:v0.142.1\", \"requestRollout\": \"$(uuidgen)\"}}"
```
...
metadata:
  ...
  namespace: materialize-environment
spec:
  environmentdImageRef: materialize/environmentd:v0.142.1 # Update version as needed
