...
| `operator.image.tag` | The tag/version of the operator image to be used | ``"v26.20.0-rc.2"`` |
...
helm install my-materialize-operator \
  --set operator.image.tag=v26.20.0-rc.2 \
...
metadata:
  ...
  namespace: materialize-environment
spec:
  environmentdImageRef: materialize/environmentd:v26.20.0-rc.2
