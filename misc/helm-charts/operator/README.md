...
![Version: v25.1.7](https://img.shields.io/badge/Version-v25.1.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.130.8](https://img.shields.io/badge/AppVersion-v0.130.8-informational?style=flat-square)
...
helm install my-materialize-operator \
  --set operator.image.tag=v0.138.0 \
