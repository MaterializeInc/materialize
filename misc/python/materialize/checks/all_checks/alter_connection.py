    ...
    def validate(self) -> Testdrive:
        ...
        return Testdrive(
            dedent(
                ...
                >[version<11900] DROP SOURCE IF EXISTS alter_connection_sink_source_{i}

                >[version>=11900] DROP TABLE IF EXISTS alter_connection_sink_source_{i}
                >[version>=11900] DROP SOURCE IF EXISTS alter_connection_sink_source_{i}_src
