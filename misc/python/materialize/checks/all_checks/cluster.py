...
class CreateCluster(Check):
    ...
    def validate(self) -> Testdrive:
        return Testdrive(dedent("""
                ...
                >[15500<=version<2603400] SHOW CREATE CLUSTER create_cluster2;
                ...
                >[version>=2603400] SHOW CREATE CLUSTER create_cluster2;
...
class AlterCluster(Check):
    ...
    def validate(self) -> Testdrive:
        return Testdrive(dedent("""
                ...
                >[15500<=version<2603400] SHOW CREATE CLUSTER alter_cluster1;
                ...
                >[version>=2603400] SHOW CREATE CLUSTER alter_cluster1;
...
class CreateClusterRF0(Check):
    ...
    def validate(self) -> Testdrive:
        return Testdrive(dedent("""
                ...
                >[15500<=version<2603400] SHOW CREATE CLUSTER create_cluster_rf0_1;
                ...
                >[version>=2603400] SHOW CREATE CLUSTER create_cluster_rf0_1;
                ...
                >[15500<=version<2603400] SHOW CREATE CLUSTER create_cluster_rf0_2;
                ...
                >[version>=2603400] SHOW CREATE CLUSTER create_cluster_rf0_2;
