    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                > CREATE MATERIALIZED VIEW parse_error_view WITH (REFRESH EVERY '2 seconds') AS SELECT f1::INTEGER FROM parse_error_table;
    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                > CREATE MATERIALIZED VIEW parse_hex_error_view WITH (REFRESH EVERY '2 seconds') AS SELECT decode(f1, 'hex') FROM parse_hex_error_table;
    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                > CREATE MATERIALIZED VIEW dataflow_error_retraction_view WITH (REFRESH EVERY '2 seconds') AS SELECT f1::INTEGER FROM dataflow_error_retraction_table;
