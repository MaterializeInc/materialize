...
class MaterializedViewsAssertNotNull(Check):
    ...
    def validate(self) -> Testdrive:
        sql = dedent(
            ...
            ? EXPLAIN OPTIMIZED PLAN SELECT * FROM not_null_view1 WHERE x IS NOT NULL
            Explained Query:
            ...
            ? EXPLAIN OPTIMIZED PLAN SELECT * FROM not_null_view2 WHERE y IS NOT NULL
            Explained Query:
            ...
            ? EXPLAIN OPTIMIZED PLAN SELECT * FROM not_null_view3 WHERE z IS NOT NULL
            Explained Query:
