    ...
    def manipulate(self) -> list[Testdrive]:
        return [
            ...
            for s in [
                ...
                > CREATE MATERIALIZED VIEW materialized_view1 WITH (REFRESH EVERY '2 seconds') AS SELECT LEFT(f1, 3), COUNT(*) FROM materialized_views_table GROUP BY LEFT(f1, 3);
                ...
                > CREATE MATERIALIZED VIEW materialized_view2 WITH (REFRESH EVERY '2 seconds') AS SELECT LEFT(f1, 3), COUNT(*) FROM materialized_views_table GROUP BY LEFT(f1, 3);
