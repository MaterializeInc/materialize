    ...
    def initialize(self) -> Testdrive:
        ...
        return Testdrive(
            ...
            + dedent(
                ...
                CREATE SOURCE multiple_partitions_source FROM KAFKA CONNECTION kafka_conn (TOPIC 'testdrive-multiple-partitions-topic-${{testdrive.seed}}', TOPIC METADATA REFRESH INTERVAL {topic_metadata_refresh_interval}) FORMAT AVRO USING CONFLUENT SCHEMA REGISTRY CONNECTION csr_conn ENVELOPE UPSERT;
