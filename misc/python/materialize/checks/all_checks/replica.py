    ...
    def manipulate(self) -> list[Testdrive]:
        return [
            ...
            for s in [
                ...
                > CREATE MATERIALIZED VIEW create_replica_view WITH (RETAIN HISTORY FOR '30s') AS SELECT SUM(f1) FROM create_replica_table;
    ...
    def manipulate(self) -> list[Testdrive]:
        return [
            ...
            for s in [
                ...
                > CREATE MATERIALIZED VIEW drop_replica_view WITH (RETAIN HISTORY FOR '30s') AS SELECT COUNT(f1) FROM drop_replica_table;
    ...
    def validate(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                > CREATE MATERIALIZED VIEW replica_annotations_mv WITH (RETAIN HISTORY FOR '30s') AS SELECT name FROM mz_tables LIMIT 1;
