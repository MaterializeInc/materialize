    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            ...
            + dedent(
                ...
                > CREATE MATERIALIZED VIEW sink_source_view WITH (RETAIN HISTORY FOR '30s') AS SELECT LEFT(key1, 2) as l_k, LEFT(f1, 1) AS l_v, COUNT(*) AS c FROM sink_source GROUP BY LEFT(key1, 2), LEFT(f1, 1);
    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            ...
            + dedent(
                ...
                > CREATE MATERIALIZED VIEW sink_large_transaction_view WITH (RETAIN HISTORY FOR '30s') AS SELECT f1 - 1 AS f1 , f2 FROM sink_large_transaction_table;
    ...
    def validate(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                > CREATE MATERIALIZED VIEW sink_large_transaction_view2 WITH (RETAIN HISTORY FOR '30s')
                  AS
                ...
                > CREATE MATERIALIZED VIEW sink_large_transaction_view3 WITH (RETAIN HISTORY FOR '30s')
                  AS
                  SELECT COUNT(*) AS c1 , COUNT(f1) AS c2, COUNT(DISTINCT f1) AS c3 , MIN(f1), MAX(f1)
                  FROM (
                ...
                > CREATE MATERIALIZED VIEW sink_large_transaction_view4 WITH (RETAIN HISTORY FOR '30s')
                  AS
    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            ...
            + dedent(
                ...
                > CREATE MATERIALIZED VIEW sink_source_null_view WITH (RETAIN HISTORY FOR '30s') AS SELECT LEFT(key1, 2) as l_k, LEFT(f1, 1) AS l_v1, f2 / 100 AS l_v2, COUNT(*) AS c FROM sink_source_null GROUP BY LEFT(key1, 2), LEFT(f1, 1), f2 / 100;
    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            ...
            + dedent(
                ...
                > CREATE MATERIALIZED VIEW sink_source_comments_view WITH (RETAIN HISTORY FOR '30s') AS SELECT LEFT(key1, 2) as l_k, LEFT(f1, 1) AS l_v1, f2 / 100 AS l_v2, COUNT(*) AS c FROM sink_source_comments GROUP BY LEFT(key1, 2), LEFT(f1, 1), f2 / 100
