    ...
    def manipulate(self) -> list[Testdrive]:
        return [
            ...
            for s in [
                ...
                > CREATE MATERIALIZED VIEW threshold_view1 WITH (REFRESH EVERY '2 seconds') AS SELECT * FROM threshold_table1 EXCEPT SELECT * FROM threshold_table2;
                > INSERT INTO threshold_table2 VALUES (2);
                """,
                """
                > INSERT INTO threshold_table1 VALUES (2);
                > CREATE MATERIALIZED VIEW threshold_view2 WITH (REFRESH EVERY '2 seconds') AS SELECT * FROM threshold_table2 EXCEPT ALL SELECT * FROM threshold_table1;
