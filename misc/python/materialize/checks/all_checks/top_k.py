    ...
    def manipulate(self) -> list[Testdrive]:
        return [
            ...
            for s in [
                ...
                > CREATE MATERIALIZED VIEW basic_topk_view1 WITH (RETAIN HISTORY FOR '30s') AS SELECT f1, COUNT(f1) FROM basic_topk_table GROUP BY f1 ORDER BY f1 DESC NULLS LAST LIMIT 2;
                > INSERT INTO basic_topk_table SELECT * FROM basic_topk_table;
                """,
                """
                > INSERT INTO basic_topk_table SELECT * FROM basic_topk_table;
                > CREATE MATERIALIZED VIEW basic_topk_view2 WITH (RETAIN HISTORY FOR '30s') AS SELECT f1, COUNT(f1) FROM basic_topk_table GROUP BY f1 ORDER BY f1 ASC NULLS FIRST LIMIT 2;
                > INSERT INTO basic_topk_table SELECT * FROM basic_topk_table;
                """,
            ]
        ]
    ...
    def manipulate(self) -> list[Testdrive]:
        return [
            ...
            for s in [
                ...
                {"f1": "B"}
                > CREATE MATERIALIZED VIEW monotonic_topk_view1 WITH (RETAIN HISTORY FOR '30s') AS SELECT f1, COUNT(f1) FROM monotonic_topk_source GROUP BY f1 ORDER BY f1 DESC NULLS LAST LIMIT 2;
                ...
                {"f1": "D"}
                > CREATE MATERIALIZED VIEW monotonic_topk_view2 WITH (RETAIN HISTORY FOR '30s') AS SELECT f1, COUNT(f1) FROM monotonic_topk_source GROUP BY f1 ORDER BY f1 ASC NULLS FIRST LIMIT 2;
    ...
    def manipulate(self) -> list[Testdrive]:
        return [
            ...
            for s in [
                ...
                {"f1": "B"}
                > CREATE MATERIALIZED VIEW monotonic_top1_view1 WITH (RETAIN HISTORY FOR '30s') AS SELECT f1, COUNT(f1) FROM monotonic_top1_source GROUP BY f1 ORDER BY f1 DESC NULLS LAST LIMIT 1;
                ...
                {"f1": "C"}
                > CREATE MATERIALIZED VIEW monotonic_top1_view2 WITH (RETAIN HISTORY FOR '30s') AS SELECT f1, COUNT(f1) FROM monotonic_top1_source GROUP BY f1 ORDER BY f1 ASC NULLS FIRST LIMIT 1;
