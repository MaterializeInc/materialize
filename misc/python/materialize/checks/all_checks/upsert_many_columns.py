    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            ...
            + dedent(
                ...
                > CREATE MATERIALIZED VIEW upsert_many_value_columns_view WITH (REFRESH EVERY '2 seconds') AS
    ...
    def initialize(self) -> Testdrive:
        return Testdrive(
            ...
            + dedent(
                ...
                > CREATE MATERIALIZED VIEW upsert_many_key_columns_view WITH (REFRESH EVERY '2 seconds') AS
