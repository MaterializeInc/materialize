...
class Identifiers(Check):
    ...
    def validate(self) -> Testdrive:
        ...
        {dq_print(self.ident["sink0"])} kafka ${{arg.default-storage-size}} {dq(self.ident["db"] + "_" + self.ident["schema"] + "_" + self.ident["sink0"] + "_")}
        {dq_print(self.ident["sink1"])} kafka ${{arg.default-storage-size}} {dq(self.ident["db"] + "_" + self.ident["schema"] + "_" + self.ident["sink1"] + "_")}
        {dq_print(self.ident["sink2"])} kafka ${{arg.default-storage-size}} {dq(self.ident["db"] + "_" + self.ident["schema"] + "_" + self.ident["sink2"] + "_")}
