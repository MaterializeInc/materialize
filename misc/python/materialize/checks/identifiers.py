...
class Identifiers(Check):
    ...
    def validate(self) -> Testdrive:
        ...
        {dq_print(self.ident["sink0"])} kafka ${{arg.default-storage-size}} {dq_print(self.ident["db"]).strip()}_{dq_print(self.ident["schema"])}_{dq_print(self.ident["sink0"])}
        {dq_print(self.ident["sink1"])} kafka ${{arg.default-storage-size}} {dq_print(self.ident["db"]).strip()}_{dq_print(self.ident["schema"])}_{dq_print(self.ident["sink1"])}
        {dq_print(self.ident["sink2"])} kafka ${{arg.default-storage-size}} {dq_print(self.ident["db"]).strip()}_{dq_print(self.ident["schema"])}_{dq_print(self.ident["sink2"])}
