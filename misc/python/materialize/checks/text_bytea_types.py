    ...
    def validate(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                materialize.public.string_bytea_types_view1 "CREATE MATERIALIZED VIEW \\"materialize\\".\\"public\\".\\"string_bytea_types_view1\\" IN CLUSTER \\"default\\" AS SELECT \\"materialize\\".\\"public\\".\\"text_bytea_types_table\\".\\"text_col\\", \\"materialize\\".\\"public\\".\\"text_bytea_types_table\\".\\"bytea_col\\", 'това'::\\"pg_catalog\\".\\"text\\", '\\\\xAAAA'::\\"pg_catalog\\".\\"bytea\\" FROM \\"materialize\\".\\"public\\".\\"text_bytea_types_table\\" WHERE \\"materialize\\".\\"public\\".\\"text_bytea_types_table\\".\\"text_col\\" >= ''::\\"pg_catalog\\".\\"text\\" AND \\"materialize\\".\\"public\\".\\"text_bytea_types_table\\".\\"bytea_col\\" >= ''::\\"pg_catalog\\".\\"bytea\\""
