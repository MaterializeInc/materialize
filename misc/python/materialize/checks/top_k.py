    ...
    def validate(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                materialize.public.basic_topk_view1 "CREATE MATERIALIZED VIEW \\"materialize\\".\\"public\\".\\"basic_topk_view1\\" IN CLUSTER \\"default\\" AS SELECT \\"materialize\\".\\"public\\".\\"basic_topk_table\\".\\"f1\\", \\"pg_catalog\\".\\"count\\"(\\"materialize\\".\\"public\\".\\"basic_topk_table\\".\\"f1\\") FROM \\"materialize\\".\\"public\\".\\"basic_topk_table\\" GROUP BY \\"materialize\\".\\"public\\".\\"basic_topk_table\\".\\"f1\\" ORDER BY \\"materialize\\".\\"public\\".\\"basic_topk_table\\".\\"f1\\" DESC NULLS LAST LIMIT 2"
                ...
                materialize.public.basic_topk_view2 "CREATE MATERIALIZED VIEW \\"materialize\\".\\"public\\".\\"basic_topk_view2\\" IN CLUSTER \\"default\\" AS SELECT \\"materialize\\".\\"public\\".\\"basic_topk_table\\".\\"f1\\", \\"pg_catalog\\".\\"count\\"(\\"materialize\\".\\"public\\".\\"basic_topk_table\\".\\"f1\\") FROM \\"materialize\\".\\"public\\".\\"basic_topk_table\\" GROUP BY \\"materialize\\".\\"public\\".\\"basic_topk_table\\".\\"f1\\" ORDER BY \\"materialize\\".\\"public\\".\\"basic_topk_table\\".\\"f1\\" ASC NULLS FIRST LIMIT 2"
    ...
    def validate(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                materialize.public.monotonic_topk_view1 "CREATE MATERIALIZED VIEW \\"materialize\\".\\"public\\".\\"monotonic_topk_view1\\" IN CLUSTER \\"default\\" AS SELECT \\"materialize\\".\\"public\\".\\"monotonic_topk_source\\".\\"f1\\", \\"pg_catalog\\".\\"count\\"(\\"materialize\\".\\"public\\".\\"monotonic_topk_source\\".\\"f1\\") FROM \\"materialize\\".\\"public\\".\\"monotonic_topk_source\\" GROUP BY \\"materialize\\".\\"public\\".\\"monotonic_topk_source\\".\\"f1\\" ORDER BY \\"materialize\\".\\"public\\".\\"monotonic_topk_source\\".\\"f1\\" DESC NULLS LAST LIMIT 2"
                ...
                materialize.public.monotonic_topk_view2 "CREATE MATERIALIZED VIEW \\"materialize\\".\\"public\\".\\"monotonic_topk_view2\\" IN CLUSTER \\"default\\" AS SELECT \\"materialize\\".\\"public\\".\\"monotonic_topk_source\\".\\"f1\\", \\"pg_catalog\\".\\"count\\"(\\"materialize\\".\\"public\\".\\"monotonic_topk_source\\".\\"f1\\") FROM \\"materialize\\".\\"public\\".\\"monotonic_topk_source\\" GROUP BY \\"materialize\\".\\"public\\".\\"monotonic_topk_source\\".\\"f1\\" ORDER BY \\"materialize\\".\\"public\\".\\"monotonic_topk_source\\".\\"f1\\" ASC NULLS FIRST LIMIT 2"
    ...
    def validate(self) -> Testdrive:
        return Testdrive(
            dedent(
                ...
                materialize.public.monotonic_top1_view1 "CREATE MATERIALIZED VIEW \\"materialize\\".\\"public\\".\\"monotonic_top1_view1\\" IN CLUSTER \\"default\\" AS SELECT \\"materialize\\".\\"public\\".\\"monotonic_top1_source\\".\\"f1\\", \\"pg_catalog\\".\\"count\\"(\\"materialize\\".\\"public\\".\\"monotonic_top1_source\\".\\"f1\\") FROM \\"materialize\\".\\"public\\".\\"monotonic_top1_source\\" GROUP BY \\"materialize\\".\\"public\\".\\"monotonic_top1_source\\".\\"f1\\" ORDER BY \\"materialize\\".\\"public\\".\\"monotonic_top1_source\\".\\"f1\\" DESC NULLS LAST LIMIT 1"

                > SELECT * FROM monotonic_top1_view1;
                D 5

                > SHOW CREATE MATERIALIZED VIEW monotonic_top1_view2;
                materialize.public.monotonic_top1_view2 "CREATE MATERIALIZED VIEW \\"materialize\\".\\"public\\".\\"monotonic_top1_view2\\" IN CLUSTER \\"default\\" AS SELECT \\"materialize\\".\\"public\\".\\"monotonic_top1_source\\".\\"f1\\", \\"pg_catalog\\".\\"count\\"(\\"materialize\\".\\"public\\".\\"monotonic_top1_source\\".\\"f1\\") FROM \\"materialize\\".\\"public\\".\\"monotonic_top1_source\\" GROUP BY \\"materialize\\".\\"public\\".\\"monotonic_top1_source\\".\\"f1\\" ORDER BY \\"materialize\\".\\"public\\".\\"monotonic_top1_source\\".\\"f1\\" ASC NULLS FIRST LIMIT 1"
