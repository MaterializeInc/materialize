...
class PgCdcBank(CdcBank):
    name = "pg-cdc-bank"
    services = ["postgres"]
    legs = ["metadata", "blob", "clusterd-storage", "clusterd-compute", "pg"]
...
class MySqlCdcBank(CdcBank):
    name = "mysql-cdc-bank"
    services = ["mysql"]
    legs = ["metadata", "blob", "clusterd-storage", "clusterd-compute", "mysql"]
...
class SqlServerCdcBank(CdcBank):
    ...
    rtr_supported = False
    services = ["sql-server"]
    legs = ["metadata", "blob", "clusterd-storage", "clusterd-compute", "sql-server"]
