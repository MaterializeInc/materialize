...
FROM
  mz_internal.mz_arrangement_sizes as ars JOIN
  mz_internal.mz_dataflow_operator_dataflows dod ON (ars.operator_id = dod.id) JOIN
  mz_internal.mz_compute_exports ce USING (dataflow_id) JOIN
