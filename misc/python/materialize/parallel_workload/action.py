...
ddl_action_list = ActionList(
    [
        ...
        (CreateRoleAction, 0),
        (DropRoleAction, 0),
        (CreateClusterAction, 0),
        (DropClusterAction, 0),
        (SwapClusterAction, 0),
        (CreateClusterReplicaAction, 0),
        (DropClusterReplicaAction, 0),
        (SetClusterAction, 0),
        (CreateWebhookSourceAction, 0),
        (DropWebhookSourceAction, 0),
        (CreateKafkaSinkAction, 0),
        ...
        (CreatePostgresSourceAction, 0),
        (DropPostgresSourceAction, 0),
        (GrantPrivilegesAction, 0),
        (RevokePrivilegesAction, 0),
        (ReconnectAction, 0),
        (CreateDatabaseAction, 0),
        (DropDatabaseAction, 0),
        (CreateSchemaAction, 0),
        (DropSchemaAction, 0),
        (RenameSchemaAction, 0),
        (RenameTableAction, 0),
        (RenameViewAction, 0),
        (RenameSinkAction, 0),
        (SwapSchemaAction, 0),
