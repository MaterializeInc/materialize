...
cap() { # cap <outfile>  (sql on stdin)
  $PSQL_USER -e materialize 2>&1 | grep -vE "NOTICE:  (connected|cluster replica)|^  (Environment ID|Region|User|Cluster|Database|Schema|Session UUID)|^Issue a SQL|View documentation|Join our Slack|^ *$" > "$OUT/$1"
}
...
(cd /home/ubuntu/materialize && nohup bin/environmentd --reset -- --unsafe-mode > /tmp/demo/environmentd-clean.log 2>&1 &)
wait_ready
log "environmentd up"
...
INSERT INTO events SELECT generate_series(40001, 80000);
INSERT INTO events SELECT generate_series(80001, 120000);
INSERT INTO events SELECT generate_series(120001, 160000);
INSERT INTO events SELECT generate_series(160001, 200000);
INSERT INTO events SELECT generate_series(200001, 240000);
INSERT INTO events SELECT generate_series(240001, 280000);
INSERT INTO events SELECT generate_series(280001, 320000);
...
sleep 2
(cd /home/ubuntu/materialize && nohup bin/environmentd -- --unsafe-mode > /tmp/demo/environmentd-clean-restart.log 2>&1 &)
wait_ready
...
INSERT INTO pageviews SELECT generate_series(1, 40000);
INSERT INTO pageviews SELECT generate_series(40001, 80000);
INSERT INTO pageviews SELECT generate_series(80001, 120000);
INSERT INTO pageviews SELECT generate_series(120001, 160000);
INSERT INTO pageviews SELECT generate_series(160001, 200000);
INSERT INTO pageviews SELECT generate_series(200001, 240000);
INSERT INTO pageviews SELECT generate_series(240001, 280000);
INSERT INTO pageviews SELECT generate_series(280001, 320000);
