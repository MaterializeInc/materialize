...
/// TODO(jkosh44)
/// TODO(jksoh44) Explain that not all types are here.
#[derive(Debug, Clone)]
...
impl CatalogState {
    ...
    fn apply_role_update(
        ...
        apply(&mut self.roles_by_name, role.name.clone(), || role.id, diff);
        apply_catalog_memory_type(
...
/// TODO(jkosh44)
fn apply_catalog_memory_type<K, V, D>(
    ...
    K: Ord,
    V: CatalogMemoryType<Durable = D> + PartialEq + Debug,
    D: DurableType,
    D::Key: Ord,
{
    match diff {
