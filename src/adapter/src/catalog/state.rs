...
use mz_repr::namespaces::{
    INFORMATION_SCHEMA, MZ_CATALOG_SCHEMA, MZ_DANGEROUS_SCHEMA, MZ_INTERNAL_SCHEMA, MZ_TEMP_SCHEMA,
    PG_CATALOG_SCHEMA,
};
...
impl CatalogState {
    ...
    pub fn get_mz_dangerous_schema_id(&self) -> &SchemaId {
        &self.ambient_schemas_by_name[MZ_DANGEROUS_SCHEMA]
    }
    ...
    pub fn is_system_schema_id(&self, id: &SchemaId) -> bool {
        id == self.get_mz_catalog_schema_id()
            ...
            || id == self.get_mz_dangerous_schema_id()
    }
