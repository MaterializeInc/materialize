...
pub enum ExecuteResponse {
    ...
    CreatedIndex,
    /// The requested foreign key was created.
    CreatedForeignKey,
...
impl TryInto<ExecuteResponse> for ExecuteResponseKind {
    ...
    fn try_into(self) -> Result<ExecuteResponse, Self::Error> {
        match self {
            ...
            ExecuteResponseKind::CreatedForeignKey => Ok(ExecuteResponse::CreatedForeignKey),
...
impl ExecuteResponse {
    pub fn tag(&self) -> Option<String> {
        ...
        match self {
            ...
            CreatedForeignKey { .. } => Some("CREATE FOREIGN KEY".into()),
    ...
    pub fn generated_from(plan: &PlanKind) -> &'static [ExecuteResponseKind] {
        ...
        match plan {
            ...
            CreateForeignKey => &[CreatedForeignKey],
