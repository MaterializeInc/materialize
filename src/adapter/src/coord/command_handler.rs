        ...
        match session.transaction() {
            ...
            TransactionStatus::InTransactionImplicit(_) | TransactionStatus::InTransaction(_) => {
                match stmt {
                    ...
                    | Statement::AlterClusterOwner(_)
                    | Statement::AlterClusterReplicaOwner(_)
                    | Statement::AlterDatabaseOwner(_)
                    | Statement::AlterSchemaOwner(_)
                    | Statement::AlterObjectOwner(_)
