    ...
    T: AstInfo,
{
    ...
    match kind {
        ...
        StatementKind::AlterClusterOwner => "alter_cluster_owner",
        StatementKind::AlterClusterReplicaOwner => "alter_cluster_replica_owner",
        StatementKind::AlterDatabaseOwner => "alter_database_owner",
        StatementKind::AlterSchemaOwner => "alter_schema_owner",
        StatementKind::AlterObjectOwner => "alter_object_owner",
