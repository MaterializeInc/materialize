...
fn scalar_type_and_array_to_reader(
    ...
    match (scalar_type, array.data_type()) {
        ...
        (
            ...
            let lower_inclusive =
                downcast_array::<BooleanArray>(Arc::clone(lower_inclusive_array));
            let upper_inclusive =
                downcast_array::<BooleanArray>(Arc::clone(upper_inclusive_array));
