...
//!  * **Raw-bytes arm** — keeps the original behavior of deserializing arbitrary
//!    bytes straight into the type, exercising the deserializer against
//!    malformed/adversarial JSON input, then re-serializing the recovered value.
