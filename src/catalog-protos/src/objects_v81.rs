...
pub struct PersistedIntrospectionSourceValue {
    pub catalog_id: PersistedIntrospectionSourceCatalogItemId,
    pub global_id: PersistedIntrospectionSourceGlobalId,
    pub oid: u32,
...
pub struct PersistedIntrospectionSourceCatalogItemId(pub u64);
...
pub struct PersistedIntrospectionSourceGlobalId(pub u64);
...
pub enum StateUpdateKind {
    ...
    PersistedIntrospectionSource(PersistedIntrospectionSource),
    Role(Role),
    RoleAuth(RoleAuth),
    Schema(Schema),
...
pub struct PersistedIntrospectionSource {
    pub key: PersistedIntrospectionSourceKey,
    pub value: PersistedIntrospectionSourceValue,
}
