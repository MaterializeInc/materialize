...
use mz_sql::session::user::{
    MZ_ANALYTICS_ROLE_ID, MZ_MONITOR_REDACTED_ROLE_ID, MZ_MONITOR_ROLE_ID, MZ_SUPPORT_ROLE_ID,
    MZ_SYSTEM_ROLE_ID, SYSTEM_USER_NAME,
};

use crate::durable::objects::SystemObjectDescription;
use crate::memory::objects::DataSourceDesc;

pub use mz_catalog_types::builtin::{
    BUILTIN_ROLES, BuiltinLog, BuiltinRole, Cardinality, LinkProperties, MZ_ANALYTICS_ROLE,
    MZ_JWT_SYNC_ROLE, MZ_MONITOR_REDACTED, MZ_MONITOR_ROLE, MZ_SUPPORT_ROLE, MZ_SYSTEM_ROLE,
...
pub use mz_catalog_types::RUNTIME_ALTERABLE_FINGERPRINT_SENTINEL;
...
mod tests {
    ...
    fn test_ontology_consistency() {
        ...
        let reference_sem_types: BTreeSet<mz_repr::SemanticType> = BTreeSet::from([
            ...
            mz_repr::SemanticType::SchemaId,
            mz_repr::SemanticType::DatabaseId,
            mz_repr::SemanticType::RoleId,
            mz_repr::SemanticType::NetworkPolicyId,
        ]);
