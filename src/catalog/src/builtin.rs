...
pub static MZ_PREPARED_STATEMENT_HISTORY_REDACTED: Lazy<BuiltinView> = Lazy::new(|| BuiltinView {
    ...
    // everything but "sql"
    sql: "
SELECT id, session_id, name, redacted_sql, prepared_at, statement_type, n_throttled
...
session_id, redacted_sql, prepared_at, statement_type, n_throttled
...
prepared_statement_name, session_id, redacted_sql, prepared_at, statement_type, n_throttled
