...
pub static BUILTINS_STATIC: LazyLock<Vec<Builtin<NameReference>>> = LazyLock::new(|| {
    ...
    let mut builtin_items = vec![
        ...
        Builtin::Log(&MZ_STORAGE_DATAFLOW_GLOBAL_IDS_PER_WORKER),
        ...
        Builtin::View(&MZ_STORAGE_DATAFLOW_GLOBAL_IDS),
        ...
        Builtin::Log(&MZ_STORAGE_STAGE_MAPPING_PER_WORKER),
        Builtin::View(&MZ_STORAGE_STAGE_MAPPING),
