...
pub static BUILTINS_STATIC: LazyLock<Vec<Builtin<NameReference>>> = LazyLock::new(|| {
    ...
    let mut builtin_items = vec![
        ...
        Builtin::MaterializedView(&MZ_FOREIGN_KEYS),
        Builtin::MaterializedView(&MZ_FOREIGN_KEY_COLUMNS),
        ...
        Builtin::View(&MZ_SHOW_FOREIGN_KEYS),
        ...
        Builtin::Index(&MZ_FOREIGN_KEYS_IND),
