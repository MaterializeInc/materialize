...
/// TODO(jkosh44)
pub trait CatalogMemoryType: From<Self::Durable> {
    type Durable;

    fn update_from(&mut self, durable: Self::Durable);
}
...
impl CatalogMemoryType for Database {
    type Durable = durable::Database;
...
impl CatalogMemoryType for Schema {
    type Durable = durable::Schema;
...
impl CatalogMemoryType for Role {
    type Durable = durable::Role;
...
impl CatalogMemoryType for Cluster {
    type Durable = durable::Cluster;
