...
/// multiplies it against physical RAM, since a resident budget must
/// derive from memory that can be resident and the announced limit
/// includes swap on swap-provisioned nodes.
///
