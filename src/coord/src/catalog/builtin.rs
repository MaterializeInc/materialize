...
lazy_static! {
    ...
    pub static ref MZ_PROCS: BuiltinTable = BuiltinTable {
        name: "mz_procs",
        schema: MZ_CATALOG_SCHEMA,
        desc: RelationDesc::empty()
            .with_column("id", ScalarType::String.nullable(false))
            ...
            .with_column("schema_id", ScalarType::Int64.nullable(false))
            .with_column("name", ScalarType::String.nullable(false))
            .with_column("arg_types_oid", ScalarType::Array(Box::new(ScalarType::Oid)).nullable(false))
            .with_column("variadic_oid", ScalarType::Oid.nullable(false)),
