...
more details, see https://materialize.com/docs/cli#experimental-mode"#
            ...
            ErrorKind::FailedMigration {
                ...
                f,
                r#"Migration from catalog content version {} failed; underlying error:
{}

Please report this issue to Materialize at
https://github.com/MaterializeInc/materialize/issues/new?labels=C-bug&template=bug.md"#,
                last_version, cause,
            ),
        }
    }
