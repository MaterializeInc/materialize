...
const MIGRATIONS: &[&dyn Migration] = &[
    ...
    INSERT INTO system_gid_mapping (schema_name, object_name, id) VALUES
        ...
        ('pg_catalog', 'int8', 1002),
        ('pg_catalog', 'int4', 1003),
        ('pg_catalog', 'text', 1004),
        ('pg_catalog', 'oid', 1005),
        ('pg_catalog', 'float4', 1006),
        ('pg_catalog', 'float8', 1007),
        ('pg_catalog', '_bool', 1008),
        ('pg_catalog', '_bytea', 1009),
        ('pg_catalog', '_int4', 1010),
        ('pg_catalog', '_text', 1011),
        ('pg_catalog', '_int8', 1012),
        ('pg_catalog', '_float4', 1013),
        ('pg_catalog', '_float8', 1014),
        ('pg_catalog', '_oid', 1015),
        ('pg_catalog', 'date', 1016),
        ('pg_catalog', 'time', 1017),
        ('pg_catalog', 'timestamp', 1018),
        ('pg_catalog', '_timestamp', 1019),
        ('pg_catalog', '_date', 1020),
        ('pg_catalog', '_time', 1021),
        ('pg_catalog', 'timestamptz', 1022),
        ('pg_catalog', '_timestamptz', 1023),
        ('pg_catalog', 'interval', 1024),
        ('pg_catalog', '_interval', 1025),
        ('pg_catalog', 'numeric', 1026),
        ('pg_catalog', '_numeric', 1027),
        ('pg_catalog', 'record', 1028),
        ('pg_catalog', '_record', 1029),
        ('pg_catalog', 'uuid', 1030),
        ('pg_catalog', '_uuid', 1031),
        ('pg_catalog', 'jsonb', 1032),
        ('pg_catalog', '_jsonb', 1033),
        ('pg_catalog', 'any', 1034),
        ('pg_catalog', 'anyarray', 1035),
        ('pg_catalog', 'anyelement', 1036),
        ('pg_catalog', 'anynonarray', 1037),
        ('pg_catalog', 'char', 1038),
        ('pg_catalog', 'varchar', 1039),
        ('pg_catalog', 'int2', 1040),
        ('pg_catalog', '_int2', 1041),
        ('pg_catalog', 'bpchar', 1042),
        ('pg_catalog', '_char', 1043),
        ('pg_catalog', '_varchar', 1044),
        ('pg_catalog', '_bpchar', 1045),
        ('pg_catalog', 'regproc', 1046),
        ('pg_catalog', '_regproc', 1047),
        ('pg_catalog', 'regtype', 1048),
        ('pg_catalog', '_regtype', 1049),
        ('pg_catalog', 'regclass', 1050),
        ('pg_catalog', '_regclass', 1051),
        ('pg_catalog', 'int2vector', 1052),
        ('pg_catalog', '_int2vector', 1053),
        ('pg_catalog', 'anycompatible', 1054),
        ('pg_catalog', 'anycompatiblearray', 1055),
        ('pg_catalog', 'anycompatiblenonarray', 1056),
        ('pg_catalog', 'list', 1998),
        ('pg_catalog', 'map', 1999),
        ('pg_catalog', 'anycompatiblelist', 1997),
        ('pg_catalog', 'anycompatiblemap', 1996),
        -- Logs
