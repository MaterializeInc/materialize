...
impl Session {
    ...
    /// portals. The cleared transaction is returned so it's operations can be
    /// handled.
    ///
...
/// The type of operation being performed by the transaction. This is needed
/// because we currently do not allow interleaving reads and writes in a
