...
"fields":[
    {"name":"status","type":"string"}, {"name":"id","type": "string"}, {
            "name": "event_count",
            "type": [
                "null",
                "long"
    ...
    {"name":"data_collections","type":["null",{"type":"array",
                                               "items": {"type":"record",
                                                        ...
                                                        "fields": [ {
                                                            ...
                                                            "name": "event_count",
                                                            "type": "long" }]}}],
                                                        "default": null}], "connect.name": "io.debezium.connector.common.TransactionMetadataValue"
}"#,
        )
        .unwrap()
    };
                ...
                ConsistencyFormatting::DebeziumAvro => {
                    for msg in messages {
                        ...
                        for (topic, count) in results {
                            ...
                            let source_name = byo_consumer
                                .source_name
                                .split('.')
                                .map(|x| x.to_string())
                                .collect::<Vec<String>>()[1..]
                                .join(".");
                            if source_name == topic.trim() {
