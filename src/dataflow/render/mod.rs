...
use crate::decode::{decode, decode_avro_values, decode_kafka_upsert, kafka_value_source};
                            ...
                            _ => {
                                let (source, capability) = match connector {
                                    ExternalSourceConnector::Kafka(c) => {
                                        ...
                                        let source =
                                            kafka_value_source(&source, &dataflow.debug_name);
                                        (source, capability)
                                    }
