...
impl SourceInfo for KafkaSourceInfo {
    ...
    fn new() -> KafkaSourceInfo {
        unimplemented!()
    }
    fn register_activator(&mut self, source_activator: Arc<Mutex<Activator>>) {
        unimplemented!()
    }

    fn can_close_timestamp(&self, consistency_info: &ConsistencyInfo, pid: &PartitionId, offset: MzOffset) -> bool {
        unimplemented!()
    }
    ...
    fn get_next_message(&mut self, consistency_info: &ConsistencyInfo, activator: &Activator) -> Option<SourceMessage> {
        unimplemented!()
    }
