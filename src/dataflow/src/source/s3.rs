...
async fn read_sqs_task(
    ...
    let received_count = "ApproximateReceiveCount".to_string();
    let message_attributes = Some(vec![received_count.clone()]);
    ...
    loop {
        let response = client
            .receive_message(ReceiveMessageRequest {
                ...
                message_attribute_names: message_attributes.clone(),
                ..Default::default()
            })
            .await;
