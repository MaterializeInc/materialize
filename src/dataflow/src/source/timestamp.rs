...
pub struct TimestampBindingBox {
    ...
    /// operators to learn about new partition assignments.
    ///
    /// Note: This is a bit of a hack, in the same way that we used partitions() before to forward new
    /// partitions from coordinator to source operator. We could factor this out of
