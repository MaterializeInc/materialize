...
use crate::storage::render::envelope_none;
use crate::storage::render::envelope_none::PersistentEnvelopeNoneConfig;
...
fn raise_key_value_errors(KV { key, val }: KV) -> Option<Result<(Option<Row>, Row), DecodeError>> {
    match (key, val) {
