...
class HanaDialect : public Dialect {
  ...
  private:
    ...
    std::vector<const char*> additionalPreparationStatements = {
        "load TPCCH.\"WAREHOUSE\" all", "merge delta of TPCCH.\"WAREHOUSE\"",
        "load TPCCH.\"DISTRICT\" all",  "merge delta of TPCCH.\"DISTRICT\"",
        "load TPCCH.\"CUSTOMER\" all",  "merge delta of TPCCH.\"CUSTOMER\"",
        "load TPCCH.\"HISTORY\" all",   "merge delta of TPCCH.\"HISTORY\"",
        "load TPCCH.\"NEWORDER\" all",  "merge delta of TPCCH.\"NEWORDER\"",
        "load TPCCH.\"ORDER\" all",     "merge delta of TPCCH.\"ORDER\"",
        "load TPCCH.\"ORDERLINE\" all", "merge delta of TPCCH.\"ORDERLINE\"",
        "load TPCCH.\"ITEM\" all",      "merge delta of TPCCH.\"ITEM\"",
        "load TPCCH.\"STOCK\" all",     "merge delta of TPCCH.\"STOCK\"",
        "load TPCCH.\"NATION\" all",    "merge delta of TPCCH.\"NATION\"",
        "load TPCCH.\"SUPPLIER\" all",  "merge delta of TPCCH.\"SUPPLIER\"",
        "load TPCCH.\"REGION\" all",    "merge delta of TPCCH.\"REGION\"",
    };
