...
pub use relation::{
    ...
    MirRelationExpr, MutationKind, ProtoAggregateExpr, ProtoAggregateFunc, ProtoColumnOrder,
    ProtoMutationKind, ProtoRowSetFinishing, ProtoTableFunc, RowSetFinishing, WindowFrame,
