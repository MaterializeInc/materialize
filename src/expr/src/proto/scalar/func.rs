...
impl From<&UnaryFunc> for ProtoUnaryFunc {
    ...
    fn from(func: &UnaryFunc) -> Self {
        ...
        let kind = match func {
            ...
            UnaryFunc::CastStringToJsonb => todo!(),
            UnaryFunc::CastJsonbToString => todo!(),
            UnaryFunc::CastJsonbOrNullToJsonb => todo!(),
            UnaryFunc::CastJsonbToInt16 => todo!(),
            UnaryFunc::CastJsonbToInt32 => todo!(),
            UnaryFunc::CastJsonbToInt64 => todo!(),
            UnaryFunc::CastJsonbToFloat32 => todo!(),
            UnaryFunc::CastJsonbToFloat64 => todo!(),
            UnaryFunc::CastJsonbToNumeric(_) => todo!(),
            UnaryFunc::CastJsonbToBool => todo!(),
