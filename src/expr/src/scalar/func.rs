...
impl BinaryFunc {
    ...
    pub fn format(
        ...
        expr_a: impl fmt::Display,
        expr_b: impl fmt::Display,
    ) -> fmt::Result {
        let default_fmt = |f: &mut fmt::Formatter<'_>| {
            if self.is_infix_op() {
        ...
        match self {
            BinaryFunc::AddInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddFloat32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddFloat64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddNumeric(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddTimestampInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddTimestampTzInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddDateTime(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddDateInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AddTimeInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AgeTimestamp(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::AgeTimestampTz(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitAndInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitAndInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitAndInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitAndUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitAndUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitAndUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitOrInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitOrInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitOrInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitOrUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitOrUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitOrUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitXorInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitXorInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitXorInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitXorUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitXorUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitXorUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftLeftInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftLeftInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftLeftInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftLeftUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftLeftUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftLeftUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftRightInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftRightInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftRightInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftRightUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftRightUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::BitShiftRightUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubFloat32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubFloat64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubNumeric(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubTimestamp(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubTimestampTz(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubTimestampInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubTimestampTzInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubDate(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubDateInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubTime(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::SubTimeInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulFloat32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulFloat64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulNumeric(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MulInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivFloat32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivFloat64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivNumeric(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DivInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModInt16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModInt32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModUint16(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModUint32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModUint64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModFloat32(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModFloat64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ModNumeric(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Eq(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::NotEq(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Lt(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Lte(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Gt(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Gte(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::LikeEscape(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::IsLikeMatchCaseSensitive(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::IsLikeMatchCaseInsensitive(s) => s.format(f, expr_a, expr_b),
            ...
            BinaryFunc::ToCharTimestamp(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ToCharTimestampTz(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DateBinTimestamp(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DateBinTimestampTz(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ExtractInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ExtractTime(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ExtractTimestamp(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ExtractTimestampTz(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ExtractDate(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DatePartInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DatePartTime(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DatePartTimestamp(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DatePartTimestampTz(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DateTruncTimestamp(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DateTruncInterval(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DateTruncTimestampTz(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::TimezoneTimestamp => default_fmt(f),
            BinaryFunc::TimezoneTimestampTz => default_fmt(f),
            BinaryFunc::TimezoneIntervalTimestamp => default_fmt(f),
            BinaryFunc::TimezoneIntervalTimestampTz => default_fmt(f),
            BinaryFunc::TimezoneIntervalTime => default_fmt(f),
            BinaryFunc::TimezoneOffset(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::TextConcat(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbGetInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbGetInt64Stringify(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbGetString(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbGetStringStringify(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbGetPath(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbGetPathStringify(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbContainsString(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MapContainsKey(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbConcat(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbContainsJsonb(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MapContainsMap(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbDeleteInt64(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::JsonbDeleteString(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MapGetValue(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MapContainsAllKeys(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MapContainsAnyKeys(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RoundNumeric(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ConvertFrom(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Left(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Position(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Right(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Trim(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::TrimLeading(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::TrimTrailing(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::EncodedBytesCharLength(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ListLengthMax(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ArrayContains(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ArrayContainsArray(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ArrayContainsArrayRev(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ArrayLength(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ArrayLower(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ArrayRemove(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ArrayUpper(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ArrayArrayConcat(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ListListConcat(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ListElementConcat(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ElementListConcat(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ListRemove(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ListContainsList(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ListContainsListRev(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DigestString(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::DigestBytes(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MzRenderTypmod(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Encode(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Decode(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::LogNumeric(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::Power(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::PowerNumeric(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RepeatString => default_fmt(f),
            BinaryFunc::Normalize => default_fmt(f),
            BinaryFunc::GetBit(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::GetByte(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ConstantTimeEqBytes(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ConstantTimeEqString(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeContainsElem { .. } => default_fmt(f),
            BinaryFunc::RangeContainsRange(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeContainsRangeRev(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeOverlaps(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeAfter(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeBefore(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeOverleft(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeOverright(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeAdjacent(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeUnion(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeIntersection(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RangeDifference(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::UuidGenerateV5(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::MzAclItemContainsPrivilege(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::ParseIdent(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::PrettySql(s) => s.format(f, expr_a, expr_b),
            BinaryFunc::RegexpReplace { .. } => default_fmt(f),
            BinaryFunc::StartsWith(s) => s.format(f, expr_a, expr_b),
        }
    }
}
...
#[sqlfunc(propagates_nulls = true, format = "position({0} in {1})")]
