...
fn age_timestamp_tz<'a>(a: Datum<'a>, b: Datum<'a>) -> Result<Datum<'a>, EvalError> {
...
fn sub_timestamp_tz<'a>(a: Datum<'a>, b: Datum<'a>) -> Datum<'a> {
...
impl BinaryFunc {
    ...
    pub fn is_monotone(&self) -> (bool, bool) {
        match self {
            ...
            BinaryFunc::Position => (false, false),
...
impl Arbitrary for BinaryFunc {
    ...
    fn arbitrary_with(_: Self::Parameters) -> Self::Strategy {
        Union::new(vec![
            ...
            Just(BinaryFunc::AddTimestampInterval(AddTimestampInterval)).boxed(),
            Just(BinaryFunc::AddTimestampTzInterval(AddTimestampTzInterval)).boxed(),
            Just(BinaryFunc::AddDateInterval(AddDateInterval)).boxed(),
            Just(BinaryFunc::AddDateTime(AddDateTime)).boxed(),
            Just(BinaryFunc::AddTimeInterval(AddTimeInterval)).boxed(),
            Just(BinaryFunc::AddNumeric(AddNumeric)).boxed(),
            Just(BinaryFunc::AgeTimestamp(AgeTimestamp)).boxed(),
            Just(BinaryFunc::AgeTimestampTz(AgeTimestampTz)).boxed(),
            Just(BinaryFunc::BitAndInt16(BitAndInt16)).boxed(),
            Just(BinaryFunc::BitAndInt32(BitAndInt32)).boxed(),
            Just(BinaryFunc::BitAndInt64(BitAndInt64)).boxed(),
            Just(BinaryFunc::BitAndUint16(BitAndUint16)).boxed(),
            Just(BinaryFunc::BitAndUint32(BitAndUint32)).boxed(),
            Just(BinaryFunc::BitAndUint64(BitAndUint64)).boxed(),
            Just(BinaryFunc::BitOrInt16(BitOrInt16)).boxed(),
            Just(BinaryFunc::BitOrInt32(BitOrInt32)).boxed(),
            Just(BinaryFunc::BitOrInt64(BitOrInt64)).boxed(),
            Just(BinaryFunc::BitOrUint16(BitOrUint16)).boxed(),
            Just(BinaryFunc::BitOrUint32(BitOrUint32)).boxed(),
            Just(BinaryFunc::BitOrUint64(BitOrUint64)).boxed(),
            Just(BinaryFunc::BitXorInt16(BitXorInt16)).boxed(),
            Just(BinaryFunc::BitXorInt32(BitXorInt32)).boxed(),
            Just(BinaryFunc::BitXorInt64(BitXorInt64)).boxed(),
            Just(BinaryFunc::BitXorUint16(BitXorUint16)).boxed(),
            Just(BinaryFunc::BitXorUint32(BitXorUint32)).boxed(),
            Just(BinaryFunc::BitXorUint64(BitXorUint64)).boxed(),
            Just(BinaryFunc::BitShiftLeftInt16(BitShiftLeftInt16)).boxed(),
            Just(BinaryFunc::BitShiftLeftInt32(BitShiftLeftInt32)).boxed(),
            Just(BinaryFunc::BitShiftLeftInt64(BitShiftLeftInt64)).boxed(),
            Just(BinaryFunc::BitShiftLeftUint16(BitShiftLeftUint16)).boxed(),
            Just(BinaryFunc::BitShiftLeftUint32(BitShiftLeftUint32)).boxed(),
            Just(BinaryFunc::BitShiftLeftUint64(BitShiftLeftUint64)).boxed(),
            Just(BinaryFunc::BitShiftRightInt16(BitShiftRightInt16)).boxed(),
            Just(BinaryFunc::BitShiftRightInt32(BitShiftRightInt32)).boxed(),
            Just(BinaryFunc::BitShiftRightInt64(BitShiftRightInt64)).boxed(),
            Just(BinaryFunc::BitShiftRightUint16(BitShiftRightUint16)).boxed(),
            Just(BinaryFunc::BitShiftRightUint32(BitShiftRightUint32)).boxed(),
            Just(BinaryFunc::BitShiftRightUint64(BitShiftRightUint64)).boxed(),
            Just(BinaryFunc::SubInt16(SubInt16)).boxed(),
            Just(BinaryFunc::SubInt32(SubInt32)).boxed(),
            Just(BinaryFunc::SubInt64(SubInt64)).boxed(),
            Just(BinaryFunc::SubUint16(SubUint16)).boxed(),
            Just(BinaryFunc::SubUint32(SubUint32)).boxed(),
            Just(BinaryFunc::SubUint64(SubUint64)).boxed(),
            Just(BinaryFunc::SubFloat32(SubFloat32)).boxed(),
            Just(BinaryFunc::SubFloat64(SubFloat64)).boxed(),
            Just(BinaryFunc::SubInterval(SubInterval)).boxed(),
            Just(BinaryFunc::SubTimestamp(SubTimestamp)).boxed(),
            Just(BinaryFunc::SubTimestampTz(SubTimestampTz)).boxed(),
            Just(BinaryFunc::SubTimestampInterval(SubTimestampInterval)).boxed(),
            Just(BinaryFunc::SubTimestampTzInterval(SubTimestampTzInterval)).boxed(),
            Just(BinaryFunc::SubDate(SubDate)).boxed(),
            Just(BinaryFunc::SubDateInterval(SubDateInterval)).boxed(),
            Just(BinaryFunc::SubTime(SubTime)).boxed(),
            Just(BinaryFunc::SubTimeInterval(SubTimeInterval)).boxed(),
            Just(BinaryFunc::SubNumeric(SubNumeric)).boxed(),
            Just(BinaryFunc::MulInt16(MulInt16)).boxed(),
            Just(BinaryFunc::MulInt32(MulInt32)).boxed(),
            Just(BinaryFunc::MulInt64(MulInt64)).boxed(),
            Just(BinaryFunc::MulUint16(MulUint16)).boxed(),
            Just(BinaryFunc::MulUint32(MulUint32)).boxed(),
            Just(BinaryFunc::MulUint64(MulUint64)).boxed(),
            Just(BinaryFunc::MulFloat32(MulFloat32)).boxed(),
            Just(BinaryFunc::MulFloat64(MulFloat64)).boxed(),
            Just(BinaryFunc::MulNumeric(MulNumeric)).boxed(),
            Just(BinaryFunc::MulInterval(MulInterval)).boxed(),
            Just(BinaryFunc::DivInt16(DivInt16)).boxed(),
            Just(BinaryFunc::DivInt32(DivInt32)).boxed(),
            Just(BinaryFunc::DivInt64(DivInt64)).boxed(),
            Just(BinaryFunc::DivUint16(DivUint16)).boxed(),
            Just(BinaryFunc::DivUint32(DivUint32)).boxed(),
            Just(BinaryFunc::DivUint64(DivUint64)).boxed(),
            Just(BinaryFunc::DivFloat32(DivFloat32)).boxed(),
            Just(BinaryFunc::DivFloat64(DivFloat64)).boxed(),
            Just(BinaryFunc::DivNumeric(DivNumeric)).boxed(),
            Just(BinaryFunc::DivInterval(DivInterval)).boxed(),
            Just(BinaryFunc::ModInt16(ModInt16)).boxed(),
            Just(BinaryFunc::ModInt32(ModInt32)).boxed(),
            Just(BinaryFunc::ModInt64(ModInt64)).boxed(),
            Just(BinaryFunc::ModUint16(ModUint16)).boxed(),
            Just(BinaryFunc::ModUint32(ModUint32)).boxed(),
            Just(BinaryFunc::ModUint64(ModUint64)).boxed(),
            Just(BinaryFunc::ModFloat32(ModFloat32)).boxed(),
            Just(BinaryFunc::ModFloat64(ModFloat64)).boxed(),
            Just(BinaryFunc::ModNumeric(ModNumeric)).boxed(),
            Just(BinaryFunc::RoundNumeric(RoundNumericBinary)).boxed(),
            Just(BinaryFunc::Eq(Eq)).boxed(),
            Just(BinaryFunc::NotEq(NotEq)).boxed(),
            Just(BinaryFunc::Lt(Lt)).boxed(),
            Just(BinaryFunc::Lte(Lte)).boxed(),
            Just(BinaryFunc::Gt(Gt)).boxed(),
            Just(BinaryFunc::Gte(Gte)).boxed(),
            Just(BinaryFunc::LikeEscape(LikeEscape)).boxed(),
            bool::arbitrary()
            ...
            bool::arbitrary()
                ...
                .boxed(),
            Just(BinaryFunc::ToCharTimestamp(ToCharTimestampFormat)).boxed(),
            Just(BinaryFunc::ToCharTimestampTz(ToCharTimestampTzFormat)).boxed(),
            Just(BinaryFunc::DateBinTimestamp(DateBinTimestamp)).boxed(),
            Just(BinaryFunc::DateBinTimestampTz(DateBinTimestampTz)).boxed(),
            Just(BinaryFunc::ExtractInterval(DatePartIntervalNumeric)).boxed(),
            Just(BinaryFunc::ExtractTime(DatePartTimeNumeric)).boxed(),
            ...
            .boxed(),
            Just(BinaryFunc::ExtractDate(ExtractDateUnits)).boxed(),
            Just(BinaryFunc::DatePartInterval(DatePartIntervalF64)).boxed(),
            Just(BinaryFunc::DatePartTime(DatePartTimeF64)).boxed(),
            Just(BinaryFunc::DatePartTimestamp(DatePartTimestampTimestampF64)).boxed(),
            Just(BinaryFunc::DatePartTimestampTz(
                DatePartTimestampTimestampTzF64,
            ))
            .boxed(),
            Just(BinaryFunc::DateTruncTimestamp(DateTruncUnitsTimestamp)).boxed(),
            Just(BinaryFunc::DateTruncTimestampTz(DateTruncUnitsTimestampTz)).boxed(),
            Just(BinaryFunc::DateTruncInterval(DateTruncInterval)).boxed(),
            ...
            Just(BinaryFunc::TimezoneOffset(TimezoneOffset)).boxed(),
            Just(BinaryFunc::TextConcat(TextConcatBinary)).boxed(),
            ...
            Just(BinaryFunc::JsonbContainsString(JsonbContainsString)).boxed(),
            Just(BinaryFunc::JsonbConcat(JsonbConcat)).boxed(),
            Just(BinaryFunc::JsonbContainsJsonb(JsonbContainsJsonb)).boxed(),
            Just(BinaryFunc::JsonbDeleteInt64(JsonbDeleteInt64)).boxed(),
            Just(BinaryFunc::JsonbDeleteString(JsonbDeleteString)).boxed(),
            Just(BinaryFunc::MapContainsKey(MapContainsKey)).boxed(),
            Just(BinaryFunc::MapGetValue(MapGetValue)).boxed(),
            Just(BinaryFunc::MapContainsAllKeys(MapContainsAllKeys)).boxed(),
            Just(BinaryFunc::MapContainsAnyKeys(MapContainsAnyKeys)).boxed(),
            Just(BinaryFunc::MapContainsMap(MapContainsMap)).boxed(),
            Just(BinaryFunc::ConvertFrom(ConvertFrom)).boxed(),
            Just(BinaryFunc::Left(Left)).boxed(),
            Just(BinaryFunc::Position).boxed(),
            Just(BinaryFunc::Right(Right)).boxed(),
            Just(BinaryFunc::RepeatString).boxed(),
            Just(BinaryFunc::Normalize).boxed(),
            Just(BinaryFunc::Trim(Trim)).boxed(),
            Just(BinaryFunc::TrimLeading(TrimLeading)).boxed(),
            Just(BinaryFunc::TrimTrailing(TrimTrailing)).boxed(),
            Just(BinaryFunc::EncodedBytesCharLength(EncodedBytesCharLength)).boxed(),
            usize::arbitrary()
                .prop_map(|max_layer| BinaryFunc::ListLengthMax { max_layer })
                .boxed(),
            Just(BinaryFunc::ArrayContains(ArrayContains)).boxed(),
            Just(BinaryFunc::ArrayLength(ArrayLength)).boxed(),
            Just(BinaryFunc::ArrayLower(ArrayLower)).boxed(),
            Just(BinaryFunc::ArrayRemove(ArrayRemove)).boxed(),
            Just(BinaryFunc::ArrayUpper(ArrayUpper)).boxed(),
            Just(BinaryFunc::ArrayArrayConcat(ArrayArrayConcat)).boxed(),
            Just(BinaryFunc::ListListConcat(ListListConcat)).boxed(),
            Just(BinaryFunc::ListElementConcat(ListElementConcat)).boxed(),
            Just(BinaryFunc::ElementListConcat(ElementListConcat)).boxed(),
            Just(BinaryFunc::ListRemove(ListRemove)).boxed(),
            Just(BinaryFunc::DigestString(DigestString)).boxed(),
            Just(BinaryFunc::DigestBytes(DigestBytes)).boxed(),
            Just(BinaryFunc::MzRenderTypmod(MzRenderTypmod)).boxed(),
            Just(BinaryFunc::Encode(Encode)).boxed(),
            Just(BinaryFunc::Decode(Decode)).boxed(),
            Just(BinaryFunc::LogNumeric(LogBaseNumeric)).boxed(),
            Just(BinaryFunc::Power(Power)).boxed(),
            Just(BinaryFunc::PowerNumeric(PowerNumeric)).boxed(),
            ...
            bool::arbitrary()
                ...
                .boxed(),
            Just(BinaryFunc::RangeOverlaps(RangeOverlaps)).boxed(),
            Just(BinaryFunc::RangeAfter(RangeAfter)).boxed(),
            Just(BinaryFunc::RangeBefore(RangeBefore)).boxed(),
            Just(BinaryFunc::RangeOverleft(RangeOverleft)).boxed(),
            Just(BinaryFunc::RangeOverright(RangeOverright)).boxed(),
            Just(BinaryFunc::RangeAdjacent(RangeAdjacent)).boxed(),
            Just(BinaryFunc::RangeUnion(RangeUnion)).boxed(),
            Just(BinaryFunc::RangeIntersection(RangeIntersection)).boxed(),
            Just(BinaryFunc::RangeDifference(RangeDifference)).boxed(),
            Just(BinaryFunc::ParseIdent(ParseIdent)).boxed(),
        ])
    }
}
