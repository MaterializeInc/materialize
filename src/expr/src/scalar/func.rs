...
use crate::scalar::ProtoBinaryFunc;
...
impl RustType<ProtoBinaryFunc> for BinaryFunc {
    fn into_proto(&self) -> ProtoBinaryFunc {
        ...
        let kind = match self {
            BinaryFunc::AddInt16(_) => AddInt16(()),
            BinaryFunc::AddInt32(_) => AddInt32(()),
            BinaryFunc::AddInt64(_) => AddInt64(()),
            BinaryFunc::AddUInt16(_) => AddUint16(()),
            BinaryFunc::AddUInt32(_) => AddUint32(()),
            BinaryFunc::AddUInt64(_) => AddUint64(()),
            BinaryFunc::AddFloat32(_) => AddFloat32(()),
            BinaryFunc::AddFloat64(_) => AddFloat64(()),
    ...
    fn from_proto(proto: ProtoBinaryFunc) -> Result<Self, TryFromProtoError> {
        ...
        if let Some(kind) = proto.kind {
            match kind {
                AddInt16(()) => Ok(BinaryFunc::AddInt16(self::AddInt16)),
                AddInt32(()) => Ok(BinaryFunc::AddInt32(self::AddInt32)),
                AddInt64(()) => Ok(BinaryFunc::AddInt64(self::AddInt64)),
                AddUint16(()) => Ok(BinaryFunc::AddUInt16(self::AddUint16)),
                AddUint32(()) => Ok(BinaryFunc::AddUInt32(self::AddUint32)),
                AddUint64(()) => Ok(BinaryFunc::AddUInt64(self::AddUint64)),
                AddFloat32(()) => Ok(BinaryFunc::AddFloat32(self::AddFloat32)),
                AddFloat64(()) => Ok(BinaryFunc::AddFloat64(self::AddFloat64)),
