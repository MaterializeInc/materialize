...
/// The canonical name of a scalar function, and its source when it is
/// generated by `#[sqlfunc]`.
///
/// For functions generated by `#[sqlfunc]` the name is that of the underlying
