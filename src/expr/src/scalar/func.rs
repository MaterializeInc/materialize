...
impl UnaryFunc {
    ...
    pub fn output_type(&self, input_type: ColumnType) -> ColumnType {
        ...
        match self {
            ...
            Cos => ScalarType::Float64.nullable(true),
            Cosh => ScalarType::Float64.nullable(true),
            Sin => ScalarType::Float64.nullable(true),
            Sinh => ScalarType::Float64.nullable(true),
            Tan => ScalarType::Float64.nullable(true),
            Tanh => ScalarType::Float64.nullable(true),
            Cot => ScalarType::Float64.nullable(true),
        }
    }
