...
#[sqlfunc(
    ...
    preserves_uniqueness = true,
    inverse = super::CastInt16ToInt64,
    is_monotone = true
)]
...
#[sqlfunc(
    ...
    preserves_uniqueness = true,
    inverse = super::CastInt32ToInt64,
    is_monotone = true
)]
...
#[sqlfunc(
    ...
    preserves_uniqueness = true,
    inverse = super::CastUint16ToInt64,
    is_monotone = true
)]
...
#[sqlfunc(
    ...
    preserves_uniqueness = true,
    inverse = super::CastUint32ToInt64,
    is_monotone = true
)]
...
#[sqlfunc(
    ...
    preserves_uniqueness = true,
    inverse = super::CastUint64ToInt64,
    is_monotone = true
)]
...
#[sqlfunc(
    CastInt64ToNumeric,
    sqlname = "bigint_to_numeric",
    could_error = self.0.is_some(),
    inverse = super::CastNumericToInt64,
    is_monotone = true,
    output_type_expr = SqlScalarType::Numeric { max_scale: self.0 }
        .nullable(input_type.nullable)
)]
fn cast_int64_to_numeric(&self, a: i64) -> Result<Numeric, EvalError> {
...
#[sqlfunc(
    ...
    preserves_uniqueness = false,
    inverse = super::CastFloat32ToInt64,
    is_monotone = true
)]
...
#[sqlfunc(
    ...
    inverse = super::CastFloat64ToInt64,
    is_monotone = true
)]
// TODO(benesch): remove potentially dangerous usage of `as`.
#[allow(clippy::as_conversions)]
...
#[sqlfunc(
    ...
    preserves_uniqueness = true,
    inverse = super::CastStringToInt64
)]
