...
impl fmt::Display for CastUint16ToNumeric {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str("smalluint_to_numeric")
    }
}
