...
impl fmt::Display for CastUint32ToNumeric {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str("uinteger_to_numeric")
    }
}
