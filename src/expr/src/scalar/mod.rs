...
impl fmt::Display for EvalError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            EvalError::UInt16OutOfRange => f.write_str("smalluint out of range"),
            EvalError::UInt32OutOfRange => f.write_str("uinteger out of range"),
            EvalError::UInt64OutOfRange => f.write_str("biguint out of range"),
