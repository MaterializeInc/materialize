...
// This file implements traits whos signature includes the std::*
// version of hashmap
...
impl RestCatalogBuilder {
    ...
    pub fn with_aws_client(mut self, aws_client: aws_types::SdkConfig) -> Self {
        self.0.aws_client = Some(aws_client);
        self
    }
}
...
pub(crate) struct RestCatalogConfig {
    ...
    #[builder(default)]
    aws_client: Option<aws_types::SdkConfig>,
}
...
impl RestCatalogConfig {
    ...
    pub(crate) fn extra_oauth_params(&self) -> BTreeMap<String, String> {
...
impl Catalog for RestCatalog {
    ...
    async fn create_namespace(
        ...
        properties: StdMap<String, String>,
    ) -> Result<Namespace> {
        let context = self.context().await?;
    ...
    async fn update_namespace(
        ...
        _properties: StdMap<String, String>,
    ) -> Result<()> {
        Err(Error::new(
    ...
    async fn create_table(
        ...
        let request = context
            ...
            .json(&CreateTableRequest {
                ...
                properties: if creation.properties.is_empty() {
                    ...
                    Some(creation.properties.into_iter().collect())
                },
            })
            .build()?;
        ...
        let metadata_location = response.metadata_location.as_ref().ok_or_else(|| {
            Error::new(
                ErrorKind::DataInvalid,
    ...
    async fn test_load_table() {
        ...
        assert_eq!(vec![&Arc::new(Snapshot::builder()
            ...
            .with_summary(Summary {
                ...
                ].iter().map(|p| (p.0.to_string(), p.1.to_string()))).into_iter().collect(),
            }).build()
            ...
            .with_body(r#"
{
    ...
    async fn test_create_table() {
        ...
        let table_creation = TableCreation::builder()
            ...
            .properties(BTreeMap::from([("owner".to_string(), "testx".to_string())]))
            .partition_spec(
