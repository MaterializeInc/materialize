...
fn pack_value(
    ...
    match value {
        ...
        Value::I32(i) => packer.push(Datum::Int(i64::from(*i))),
        Value::I64(i) => packer.push(Datum::Int(*i)),
        Value::U32(i) => packer.push(Datum::UInt(u64::from(*i))),
        Value::U64(i) => packer.push(Datum::UInt(*i)),
