...
enum Command {
    ...
    ///
    /// Parses all SQL files, validates dependencies, and type-checks SQL
    /// locally. This is useful for local development and CI/CD pipelines
    ...
    ///   mz-deploy stage --deploy-id abc123 # Use custom deploy ID
    #[command(
        hide = true,
    ...
    ///
    /// Creates the `_mz_deploy` database and all tracking tables used by
    /// stage, promote, list, describe, and log commands. This is idempotent —
