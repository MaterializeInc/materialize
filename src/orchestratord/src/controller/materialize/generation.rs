...
use k8s_openapi::{
    api::{
        ...
        core::v1::{
            ...
            Service, ServicePort, ServiceSpec, TCPSocketAction, Toleration, Volume, VolumeMount,
        },
    },
...
static V26_17_0: LazyLock<Version> = LazyLock::new(|| Version {
    major: 26,
    minor: 15,
    patch: 0,
    pre: Prerelease::new("dev.0").expect("dev.0 is valid prerelease"),
...
fn create_environmentd_statefulset_object(
    ...
    if mz.meets_minimum_version(&V147_DEV0) {
        ...
        // Prior to v26.17.0, enabling the superuser and login attribute was done via
        // setting enable_password_auth=true. Starting with v26.17.0, both the
        ...
        if !matches!(mz.spec.authenticator_kind, AuthenticatorKind::Frontegg)
            && mz.meets_minimum_version(&V26_17_0)
        {
