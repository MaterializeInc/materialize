...
pub fn all_dyncfgs(configs: ConfigSet) -> ConfigSet {
    mz_persist::cfg::all_dyn_configs(configs)
        ...
        .add(&crate::internal::machine::CONSENSUS_RETRYER_CLAMP)
        .add(&crate::internal::machine::CONSENSUS_RETRYER_INITIAL_BACKOFF)
        .add(&crate::internal::machine::CONSENSUS_RETRYER_MULTIPLIER)
