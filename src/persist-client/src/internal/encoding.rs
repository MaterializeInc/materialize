...
use crate::internal::state::{
    ...
    ProtoIdHollowBatch, ProtoIdSpineBatch, ProtoInlinedDiffs, ProtoLeasedReaderState,
    ProtoLevelFuelingMerge, ProtoRollup, ProtoSpineBatch, ProtoSpineId, ProtoStateDiff,
