...
// The `fuzz` feature re-exports internal types (see `fuzz_exports`) that are
...
/// Internal durable-state types re-exported under `cfg(feature = "fuzz")` so the
/// fuzz crate can drive their proto round-trips (`ProtoRollup`/`ProtoStateDiff`
