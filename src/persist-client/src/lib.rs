...
impl PersistClient {
    ...
    /// [Self::compare_and_append_batch] or [Self::append_batch], or which can
    /// be read using [PersistClient::read_batches_consolidated].
    ///
    ...
    // WIP: Do we want to let callers inject sth like MFP here? WIP: This
    // doesn't need async right now, but still might want it in the API to have
