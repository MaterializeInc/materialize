...
//! Tests for the actor-based (log + S3) acceptor + learner.
...
pub(super) fn test_learner_metrics() -> LearnerMetrics {
    LearnerMetrics::register(&MetricsRegistry::new())
}

pub(super) fn test_acceptor_config() -> AcceptorConfig {
    AcceptorConfig {
...
pub(super) fn test_learner_config() -> LearnerConfig {
    LearnerConfig {
