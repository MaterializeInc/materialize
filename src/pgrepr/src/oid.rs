...
pub const FUNC_MZ_WINDOW_TUMBLING_TS_OID: u32 = 16_448;
pub const FUNC_MZ_WINDOW_TUMBLING_TSTZ_OID: u32 = 16_449;
pub const FUNC_MZ_WINDOW_HOPPING_TS_OID: u32 = 16_450;
pub const FUNC_MZ_WINDOW_HOPPING_TSTZ_OID: u32 = 16_451;
// next ID: 16_452
