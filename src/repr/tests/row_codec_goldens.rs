...
//
// This will be particularly easy to accidentally violate because, for speed, we
// directly reuse Row's internal encoding format. So we need to be extra
// defensive, hence this test. Note that the goal is this isn't to prevent work
// on the internal encoding of Row, but instead to catch situations where we
// need to introduce migration code.
//
...
// backward compatibility. Once we do, any changes to the internal format of Row
// will require a bit of migration code in Codec::decode to detect and handle
// the previous version.
//
// NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
//
// Do not update any of the expected values in this file without involving
// danhhz (to sanity check that its done correctly). See the above comment for
// why.
//
// NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
#[test]
