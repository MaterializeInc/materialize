...
impl<'a> Parser<'a> {
    ...
    /// Parse an `DECLARE` statement, assuming that the `DECLARE` token
    /// has already been consumed.
    ...
    /// Parse an `CLOSE` statement, assuming that the `CLOSE` token
    /// has already been consumed.
    ...
    /// Parse an `FETCH` statement, assuming that the `FETCH` token
    /// has already been consumed.
