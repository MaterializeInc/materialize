    ...
    static ref OP_IMPLS: HashMap<&'static str, Func> = {
        ...
        builtins! {
            ...
            "<" => Scalar {
                ...
                params!(Uuid, Uuid) => BinaryFunc::Lt,
            ...
            "<=" => Scalar {
                ...
                params!(Uuid, Uuid) => BinaryFunc::Lte,
            ...
            ">" => Scalar {
                ...
                params!(Uuid, Uuid) => BinaryFunc::Gte,
            ...
            "=" => Scalar {
                ...
                params!(Uuid, Uuid) => BinaryFunc::Eq,
            ...
            "<>" => Scalar {
                ...
                params!(Uuid, Uuid) => BinaryFunc::NotEq,
