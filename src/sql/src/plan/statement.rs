...
pub fn describe(
    ...
    let desc = match stmt {
        ...
        Statement::CreateClusterShadow(stmt) => ddl::describe_create_cluster_shadow(&scx, stmt)?,
...
pub fn plan(
    ...
    let plan = match stmt {
        ...
        Statement::CreateClusterShadow(stmt) => ddl::plan_create_cluster_shadow(scx, stmt),
