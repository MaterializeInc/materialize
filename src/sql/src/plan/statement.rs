...
pub fn describe(
    ...
    let desc = match stmt {
        ...
        Statement::CreateViews(_stmt) => unimplemented!("cannot describe create views statement"),
...
pub fn plan(
    ...
    match stmt {
        ...
        Statement::CreateViews(_stmt) => unimplemented!("cannot plan create views statement"),
