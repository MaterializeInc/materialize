...
use dataflow_types::{
    ...
    ExternalSourceConnector, FileSourceConnector, IncludedColumnPos, KafkaSinkConnectorBuilder,
    KafkaSinkConnectorRetention, KafkaSinkFormat, KafkaSourceConnector, KeyEnvelope,
