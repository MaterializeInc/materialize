...
use mz_sql_parser::ast::{
    ...
    LoadGeneratorOptionName, MaterializedViewOption, MaterializedViewOptionName, MetricOption,
    MetricOptionName, MySqlConfigOption, MySqlConfigOptionName, NetworkPolicyOption,
