...
pub struct VarDefinition {
    ...
    /// LaunchDarkly sync loop. Defaults to [`ParameterScope::Environment`].
...
impl VarDefinition {
    ...
    /// Declares the [`ParameterScope`] of this variable, overriding the default
    /// of [`ParameterScope::Environment`]. See the scoped feature flags design
    /// for the semantics of each scope class.
...
macro_rules! feature_flags {
    // Resolve an optional `scope:` field to a `ParameterScope`, defaulting to
    ...
    ($({
        ...
        // The optional scope class. Defaults to `ParameterScope::Environment`.
