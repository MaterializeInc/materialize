...
const MZ_SYSTEM_ROLE_ID: objects_v20::RoleId = objects_v20::RoleId {
    value: Some(objects_v20::role_id::Value::System(1)),
};
const ACL_MODE_CREATE_CLUSTER: u64 = 1 << 29;
const ACL_MODE_CREATE_DB: u64 = 1 << 30;
const ACL_MODE_CREATE_ROLE: u64 = 1 << 31;
const MZ_SYSTEM_ACL_MODE: objects_v20::AclMode = objects_v20::AclMode {
...
pub async fn upgrade(tx: &'_ mut Transaction<'_>) -> Result<(), StashError> {
    const SYSTEM_PRIVILEGES_COLLECTION: TypedCollection<objects_v20::SystemPrivilegesKey, ()> =
    ...
    SYSTEM_PRIVILEGES_COLLECTION
        .initialize(
            tx,
            vec![(
                objects_v20::SystemPrivilegesKey {
                    privileges: Some(objects_v20::MzAclItem {
...
mod tests {
    ...
    use super::objects_v20::{self};
    use crate::upgrade::v19_to_v20::{MZ_SYSTEM_ACL_MODE, MZ_SYSTEM_ROLE_ID};
    ...
    async fn smoke_test() {
        ...
        // Read back the items.
        let system_privileges: TypedCollection<objects_v20::SystemPrivilegesKey, ()> =
            TypedCollection::new("system_privileges");
        ...
        assert_eq!(
            privileges,
            vec![objects_v20::SystemPrivilegesKey {
                privileges: Some(objects_v20::MzAclItem {
                    grantee: Some(MZ_SYSTEM_ROLE_ID),
                    grantor: Some(MZ_SYSTEM_ROLE_ID),
                    acl_mode: Some(MZ_SYSTEM_ACL_MODE),
