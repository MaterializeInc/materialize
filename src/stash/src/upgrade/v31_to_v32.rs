...
wire_compatible!(objects_v30::RoleKey with objects_v31::RoleKey);
wire_compatible!(objects_v30::RoleValue with objects_v31::RoleValue);

const MZ_INTROSPECTION_ROLE_ID: objects_v31::RoleId = objects_v31::RoleId {
...
pub async fn upgrade(tx: &'_ mut Transaction<'_>) -> Result<(), StashError> {
    const ROLES_COLLECTION: TypedCollection<objects_v30::RoleKey, objects_v30::RoleValue> =
        TypedCollection::new("role");

    let old_role_key = objects_v31::RoleKey {
        id: Some(MZ_INTROSPECTION_ROLE_ID),
    };

    ROLES_COLLECTION
        .migrate_compat::<objects_v31::RoleKey, objects_v31::RoleValue>(tx, |entries| {
...
mod tests {
    ...
    use crate::upgrade::v30_to_v31::{objects_v30, objects_v31, MZ_INTROSPECTION_ROLE_ID};
    ...
    async fn smoke_test() {
        ...
        let roles_v30: TypedCollection<objects_v30::RoleKey, objects_v30::RoleValue> =
            TypedCollection::new("role");

        let system_role_id_v30 = objects_v30::RoleId {
            value: Some(objects_v30::role_id::Value::System(1)),
        };
        let introspection_role_id_v30 = objects_v30::RoleId {
            value: Some(objects_v30::role_id::Value::System(2)),
        };
        ...
        roles_v30
            .insert_without_overwrite(
                ...
                vec![
                    (
                        objects_v30::RoleKey {
                            id: Some(system_role_id_v30),
                        },
                        objects_v30::RoleValue {
                            name: "mz_system".to_string(),
                            attributes: Some(objects_v30::RoleAttributes { inherit: true }),
                            membership: Some(objects_v30::RoleMembership {
                                map: Default::default(),
                            }),
                        },
                    ),
                    (
                        objects_v30::RoleKey {
                            id: Some(introspection_role_id_v30),
                        },
                        objects_v30::RoleValue {
        ...
        let roles_v31: TypedCollection<objects_v31::RoleKey, objects_v31::RoleValue> =
            TypedCollection::new("role");
        let roles = roles_v31.iter(&mut stash).await.unwrap();
