...
#[tokio::test]
#[should_panic(expected = "stash_proto_migrate")]
...
async fn test_failures() {
    ...
    // Always fail one of the failpoints, which should eventually cause us to exhaust our retries.
    fail::cfg("stash_proto_migrate", "return(1)").unwrap();
