...
pub struct SourceStatisticsUpdate {
    ...
    pub rehydration_finished: bool,
    pub rehydration_latency_seconds: u64,
}
...
impl PackableStats for SourceStatisticsUpdate {
    fn pack(&self, mut packer: mz_repr::RowPacker<'_>) {
        ...
        packer.push(Datum::from(self.rehydration_finished));
        packer.push(Datum::from(self.rehydration_latency_seconds));
    }
}
                    ...
                    Stats(ProtoStatisticsUpdates {
                        source_updates: source_stats
                            ...
                            .map(|update| ProtoSourceStatisticsUpdate {
                                ...
                                rehydration_finished: update.rehydration_finished,
                                rehydration_latency_seconds: update.rehydration_latency_seconds,
                            })
                            .collect(),
