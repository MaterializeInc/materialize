...
use mz_storage_client::controller::{
    ...
    ExportState, IntrospectionType, MonotonicAppender, ReadPolicy, StorageController,
};
    ...
    DurableExportMetadata<T>: RustType<proto::DurableExportMetadata>,
{
    ...
    async fn alter_collection(
        ...
        for (id, ingestion) in collections.into_iter() {
    ...
    async fn update_export_connection(
        ...
        for (id, connection) in exports {
            ...
            let durable_export_data = DurableExportMetadata::from_proto(value)
                .map_err(|e| StorageError::IOError(e.into()))?;
