...
use mz_interchange::avro::WriterSchemas;
        ...
        DataEncoding::Avro(AvroEncoding {
            ...
            let writer_schemas = match wire_format {
                ...
                WireFormat::Confluent { registry } => {
                    ...
                    WriterSchemas::confluent(client)?
                }
                WireFormat::Glue { registry } => {
                    let (client, expected_registry) = match registry {
                    ...
                    WriterSchemas::glue(client, expected_registry)
                }
            };
