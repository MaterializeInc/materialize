                        ...
                        |scope| {
                            let (previous, previous_token, feedback_handle) =
                                if Timestamp::minimum() < upper_ts {
                                    ...
                                    let (feedback_handle, granular_flow_control) =
                                                ...
                                                .storage_dataflow_max_inflight_bytes
                                        {
                                            ...
                                            (
                                                ...
                                                Some(persist_source::GranularFlowControl {
                            ...
                            // If granular backpressure is enabled, we probe the upsert operator's
                            ...
                            (
                                upsert.leave().map(|(d, t, r)| (d, t.0, r)),
                                health_update.leave(),
                            )
                        },
                    );
