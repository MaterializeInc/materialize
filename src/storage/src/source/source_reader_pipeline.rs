    ...
    S: SourceReader,
{
    ...
    let mut resume_input = builder.new_input_connection(
        resume_stream,
        Pipeline,
        // The resumption frontier doesn't affect the output frontier
        vec![Antichain::new()],
    );
