...
impl ::protobuf::Message for RepeatedSimple {
    ...
    fn default_instance() -> &'static RepeatedSimple {
        static mut instance: ::protobuf::lazy::Lazy<RepeatedSimple> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for RepeatedStruct {
    ...
    fn default_instance() -> &'static RepeatedStruct {
        static mut instance: ::protobuf::lazy::Lazy<RepeatedStruct> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
