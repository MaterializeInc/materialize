    ...
    G: Scope,
{
    ...
    where
        ...
        B: FnOnce(
            Capability<G::Timestamp>,
            OperatorInfo,
            AsyncInputHandle<G::Timestamp, Vec<D1>, Capability<G::Timestamp>, P::Puller>,
    ...
    where
        ...
        B: FnOnce(
            Capability<G::Timestamp>,
            OperatorInfo,
            AsyncInputHandle<G::Timestamp, Vec<D1>, Capability<G::Timestamp>, P1::Puller>,
            AsyncInputHandle<G::Timestamp, Vec<D2>, Capability<G::Timestamp>, P2::Puller>,
    ...
    where
        B: FnOnce(
            OperatorInfo,
            AsyncInputHandle<G::Timestamp, Vec<D1>, G::Timestamp, P::Puller>,
        ) -> BFut,
        BFut: Future + 'static,
        P: ParallelizationContract<G::Timestamp, D1>;
    ...
    G: Scope,
{
        ...
        P: ParallelizationContract<G::Timestamp, D1>,
    {
        ...
        let (output, stream) = builder.new_disconnected_output();
        let input = builder.new_input_for(self, pact, 0);
        ...
        P2: ParallelizationContract<G::Timestamp, D2>,
    {
        ...
        let (output, stream) = builder.new_disconnected_output();
        let input1 = builder.new_input_for(self, pact1, 0);
        let input2 = builder.new_input_for(other, pact2, 0);
