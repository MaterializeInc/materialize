...
from materialize.mzcompose.services.frontegg import Frontegg
...
FRONTEGG_URL = "http://frontegg:6880/"
...
SERVICES = [
    ...
    Frontegg(
        tenant_id=TENANT_ID,
        encoding_key_file="/secrets/frontegg.key",
    ...
    Materialized(
        options=[
            ...
            "--frontegg-jwk-file=/secrets/frontegg.crt",
...
def workflow_wide_result(c: Composition) -> None:
    ...
    c.up("balancerd", "frontegg", "materialized")
