...
# The slot name also reaches the dump a second time, hex-encoded inside the
# protobuf `DETAILS` option of a Postgres source's create_sql, where
# SLOT_PATTERN cannot see it. "materialize_" encodes to
