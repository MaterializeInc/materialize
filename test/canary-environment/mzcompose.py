...
CONFLUENT_CLOUD_QA_CANARY_CSR_USERNAME = os.getenv(
    "CONFLUENT_CLOUD_QA_CANARY_CSR_USERNAME"
)
CONFLUENT_CLOUD_QA_CANARY_CSR_PASSWORD = os.getenv(
    "CONFLUENT_CLOUD_QA_CANARY_CSR_PASSWORD"
)
CONFLUENT_CLOUD_QA_CANARY_KAFKA_USERNAME = os.getenv(
    ...
    with c.override(
        ...
        c.testdrive(
            ...
            > CREATE CONNECTION IF NOT EXISTS kafka_connection TO KAFKA (
              BROKER '{CONFLUENT_CLOUD_QA_CANARY_KAFKA_BROKER}',
              SASL MECHANISMS = 'PLAIN',
              SASL USERNAME = SECRET kafka_username,
              SASL PASSWORD = SECRET kafka_password
              )

            > CREATE SECRET IF NOT EXISTS csr_username AS '{CONFLUENT_CLOUD_QA_CANARY_CSR_USERNAME}'
            > CREATE SECRET IF NOT EXISTS csr_password AS '{CONFLUENT_CLOUD_QA_CANARY_CSR_PASSWORD}'

            > CREATE CONNECTION IF NOT EXISTS csr_connection TO CONFLUENT SCHEMA REGISTRY (
              URL '{CONFLUENT_CLOUD_QA_CANARY_CSR_URL}',
