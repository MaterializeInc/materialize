    ...
    for disruption in disruptions:
        ...
        c.testdrive(
            ...
            + dedent(
                ...
                > CREATE MATERIALIZED VIEW v1 WITH (RETAIN HISTORY FOR '30s') AS
        ...
        c.testdrive(
            ...
            + dedent(
                ...
                > CREATE MATERIALIZED VIEW v3 WITH (RETAIN HISTORY FOR '30s') AS
                  SELECT COUNT(*) AS c1, COUNT(DISTINCT f1) AS c2, COUNT(DISTINCT f2) AS c3,
                         MIN(f1) AS min1, MIN(f2) AS min2, MAX(f1) AS max1, MAX(f2) AS max2
                  FROM t1;

                > CREATE MATERIALIZED VIEW v4 WITH (RETAIN HISTORY FOR '30s') AS
                  SELECT COUNT(*) AS c1, COUNT(DISTINCT f1) AS c2, COUNT(DISTINCT f2) AS c3,
                         MIN(f1) AS min1, MIN(f2) AS min2, MAX(f1) AS max1, MAX(f2) AS max2
                  FROM s1;
