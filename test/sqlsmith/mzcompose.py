...
def workflow_default(c: Composition, parser: WorkflowArgumentParser) -> None:
    ...
    for mz_server in MZ_SERVERS:
        ...
        c.sql(
            ...
            CREATE MATERIALIZED VIEW mv WITH (RETAIN HISTORY FOR '30s') AS SELECT a + b AS col1, c + d AS col2, e + f AS col3, g AS col4 FROM t;
            CREATE MATERIALIZED VIEW mv2 WITH (RETAIN HISTORY FOR '30s') AS SELECT count(*) FROM mv;
