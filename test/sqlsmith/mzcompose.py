...
def workflow_default(c: Composition, parser: WorkflowArgumentParser) -> None:
    ...
    for mz_server in MZ_SERVERS:
        ...
        c.sql(
            ...
            CREATE MATERIALIZED VIEW mv WITH (REFRESH EVERY '2 seconds') AS SELECT a + b AS col1, c + d AS col2, e + f AS col3, g AS col4 FROM t;
            CREATE MATERIALIZED VIEW mv2 WITH (REFRESH EVERY '2 seconds') AS SELECT count(*) FROM mv;
