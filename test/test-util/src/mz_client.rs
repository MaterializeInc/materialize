...
pub async fn client(host: &str, port: u16) -> anyhow::Result<Client> {
...
// database-issues#9092: anyhow should not be used.
#[allow(clippy::disallowed_types)]
fn check_error(e: Error) -> anyhow::Result<()> {
...
// database-issues#9092: anyhow should not be used.
#[allow(clippy::disallowed_types)]
pub async fn show_sources(mz_client: &Client) -> anyhow::Result<Vec<String>> {
    let mut res = Vec::new();
...
// database-issues#9092: anyhow should not be used.
#[allow(clippy::disallowed_types)]
pub async fn drop_source(mz_client: &Client, name: &str) -> anyhow::Result<()> {
...
// database-issues#9092: anyhow should not be used.
#[allow(clippy::disallowed_types)]
pub async fn drop_table(mz_client: &Client, name: &str) -> anyhow::Result<()> {
...
// database-issues#9092: anyhow should not be used.
#[allow(clippy::disallowed_types)]
pub async fn drop_index(mz_client: &Client, name: &str) -> anyhow::Result<()> {
...
// database-issues#9092: anyhow should not be used.
#[allow(clippy::disallowed_types)]
pub async fn execute(mz_client: &Client, query: &str) -> anyhow::Result<u64> {
    debug!("exec=> {}", query);
